...
| **Integrante**                      | **Tarea Asignada**                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Renzo Sebastian Uribe Livia**     | Se encargó del **Bounded Context de Reports**, desarrollando funcionalidades para visualizar datos recolectados y su estructura técnica. Además, apoyó en ajustes y correcciones del **Bounded Context de Control Panel**, realizando mejoras clave en la interfaz y conexión de datos. Participó en la planificación y ejecución del **Sprint 4**, asegurando la integración de los módulos y el avance del equipo. |
| **Sandoval Paiva Valentino**        | Lideró la planificación del sprint (*Sprint Planning*), se encargó del despliegue del software para la revisión final (*Sprint Review*) y desarrolló el **Bounded Context de Collection Points** con sus flujos, validaciones y conexión a base de datos. También gestionó configuraciones del módulo **IAM (Identity and Access Management)** para asegurar la autenticación y acceso correcto al sistema. |
| **Fabian Alejandro Oliva Lopez**    | Trabajó en el **Bounded Context de Recompensas**, desarrollando su lógica, estructura y validaciones. Además, elaboró evidencias de desarrollo para la revisión final, así como el diseño y registro de entrevistas. Participó activamente en la documentación de aspectos clave del equipo como *Leaders and Collaborators* y aportó en pruebas funcionales. |
| **Marcia Victoria Melgarejo Gomez** | Se encargó de las **conexiones del Bounded Context de Tips**, asegurando su comunicación con otros módulos mediante tokens. Corrigió historias de usuario e incluyó *technical stories* y *tasks* adicionales en el sprint backlog para mejorar la planificación y ejecución del desarrollo. Colaboró activamente en pruebas e integración. |
| **Gabriel Fernando Gordon Salas**   | Elaboró y refinó el **Sprint Backlog**, organizando historias, tareas y prioridades. Desarrolló el **Bounded Context de Control Panel**, asegurando su conexión entre el backend y el frontend, con integración funcional de sensores, zonas y parámetros críticos para el monitoreo. Apoyó en pruebas cruzadas con otros módulos y validación visual de datos. |                                                                                    |


## Student Outcome
| Criterio específico | Acciones realizadas    | Conclusiones    |
|---------------------|  ----------------------|-----------------|
| *3.c1 Comunica de manera oral con efectividad a diferentes rangos de audiencia*                     |                            *Gabriel Gordon<br>TB1:* Presenté el diseño de la landing page, los mock-ups y diagramas al equipo, explicando visualmente el flujo del usuario. También expliqué el diagrama de clases y el modelo de base de datos durante sesiones colaborativas.<br>*TP:* Expuse el módulo de Reports, explicando su lógica visual y técnica a todo el equipo, adaptando el lenguaje para programadores y diseñadores.<br>*TB2:* Expliqué el funcionamiento del Bounded Context de Control Panel, presentando cómo se integran sensores, zonas y residuos, detallando sus endpoints y lógica de uso. <br>*TF:* Expliqué la conexión entre los Bounded Contexts del sistema de monitoreo, incluyendo validaciones cruzadas y dependencias entre módulos.<br><br>   *Renzo Uribe<br>TB1:* Expuse ideas para la estructura del sistema en sesiones de ideación.<br>*TP:* Expliqué la arquitectura del módulo Home, su integración con otros módulos y resolví dudas técnicas en reuniones grupales.<br>*TB2:* Mostré cómo se conectan los datos del BackEnd con la visualización del FrontEnd, participando activamente en sesiones para validar endpoints.     <br><br>    *Valentino Sandoval<br>TB1:* Lideré sesiones para validar las historias de usuario y propuestas de arquitectura.<br>*TP:* Dirigí reuniones del Sprint 2, presenté avances del módulo Collection Points y expliqué su integración a los demás integrantes.<br>*TB2:* Expliqué cómo funciona el Bounded Context de Collection Points y realicé el despliegue del FrontEnd, BackEnd y la última versión funcional del FrontEnd, detallando su integración al equipo.           <br><br>           *Fabián Oliva<br>TB1:* Presenté propuestas sobre cómo organizar la interfaz de configuración.<br>*TP:* Expliqué el módulo Control Panel en sesiones grupales, detallando sus funcionalidades clave y aclarando dudas.<br>*TB2:* Participé activamente en reuniones para validar la conexión entre módulos y comunicar posibles mejoras en la usabilidad y respuesta de los endpoints. <br><br> *Marcia Melgarejo<br>TB1:* Participé en presentaciones del journey map y del diseño de la app.<br>*TP:* Expuse el flujo funcional del módulo Sustainable Actions y cómo se alinea con los objetivos ecológicos del sistema.<br>*TB2:* Expliqué al equipo el backend de Sustainable Actions, mostrando el uso de comandos, queries y el controlador REST en una reunión breve y clara.<br>*TF:* Expliqué la conexión entre Bounded Contexts de Tips/Acciones Sostenibles, manejo de tokens, lógica de puntos y coordinación del avance del sprint.                        |            *TB1:* El equipo realizó sesiones colaborativas para revisar y presentar diagramas, flujos y diseños. Se demostró una comunicación efectiva al explicar conceptos técnicos y de diseño, facilitando la toma de decisiones en etapas tempranas.<br><br>*TP:* En las reuniones grupales del Sprint 2, todos los integrantes presentaron sus avances, explicaron el funcionamiento de sus módulos y dieron retroalimentación constructiva. Se logró una comunicación oral fluida que permitió una integración exitosa del sistema.<br><br>*TB2:* En las sesiones finales, cada integrante expuso su Bounded Context. Se explicó cómo se integran los módulos entre sí y se coordinaron pruebas conjuntas, manteniendo una comunicación clara y técnica durante todo el proceso.<br><br>*TF:* CleanView fue desplegado exitosamente con todos los módulos integrados y funcionando correctamente. La coordinación entre los Bounded Contexts permitió pruebas finales sin errores críticos. |
| *3.c2 Comunica por escrito con efectividad a diferentes rangos de audiencia*                      |                         *Gabriel Gordon<br>TB1:* Redacté documentación de los user persona, journey map, impact map, backlog, wireframes y mock-ups con lenguaje claro y técnico.<br>*TP:* Elaboré descripciones funcionales del módulo Reports y colaboré en la redacción técnica de los entregables finales.<br>*TB2:* Documenté el Bounded Context de Control Panel, incluyendo endpoints y estructura de datos, con un enfoque claro y ordenado para su fácil integración.<br>*TF:* Documenté las conexiones del sistema de monitoreo entre Bounded Contexts.                <br><br>    *Renzo Uribe<br>TB1:* Escribí partes del documento de arquitectura del sistema.<br>*TP:* Documenté el diseño funcional del módulo Home, flujos de navegación y estructura de carpetas.<br>*TB2:* Colaboré en la redacción de documentación técnica relacionada con pruebas de integración y endpoints del módulo FrontEnd.     <br><br>     *Valentino Sandoval<br>TB1:* Redacté partes de las historias de usuario y backlog inicial.<br>*TP:* Escribí la documentación del módulo Collection Points, incluyendo formularios, validaciones y casos de uso.<br>*TB2:* Redacté la documentación de despliegue de FrontEnd y BackEnd, así como los endpoints desarrollados del Bounded Context Collection Points.       <br><br>  *Fabián Oliva<br>TB1:* Redacté parte de la propuesta técnica del sistema.<br>*TP:* Documenté el módulo Control Panel, incluyendo endpoints, estructura técnica y comportamiento funcional.<br>*TB2:* Apoyé en la revisión y mejora de la documentación del backend, enfocándome en la claridad de instrucciones para pruebas.    <br><br> *Marcia Melgarejo<br>TB1:* Elaboré documentación escrita del impacto ambiental del sistema y contribuciones al diseño UX.<br>*TP:* Documenté el módulo Sustainable Actions, su flujo funcional y su aporte a los objetivos del sistema.<br>*TB2:* Redacté la documentación del backend (endpoints, comandos y queries) para que los demás integren el módulo sin dudas.<br>*TF:* Documenté la integración del Bounded Context de Acciones Sostenibles, definiendo flujos de validación con tokens y lógica de puntos acumulados.                              |                        *TB1:* El equipo elaboró entregables escritos organizados y detallados que comunicaban efectivamente tanto la visión del producto como la arquitectura propuesta. Esto permitió que todos tuvieran una comprensión común de la base del proyecto.<br><br>*TP:* La documentación del sistema fue desarrollada de manera colaborativa. Cada miembro redactó las especificaciones de su módulo con lenguaje técnico y accesible, permitiendo una integración clara y comprensible de todas las partes del sistema.<br><br>*TB2:* Se creó una documentación técnica estandarizada para todos los módulos del BackEnd, permitiendo la conexión e integración fluida entre los Bounded Contexts. Se redactaron descripciones claras de los endpoints, ejemplos de uso y flujos de integración.<br><br>*TF:* La documentación sirvió como base para el despliegue exitoso de CleanView, garantizando que cada módulo se integrara correctamente con sus dependencias y facilitando pruebas finales sin errores. |
...
| **Entrevista** | 1 | **Nombre** | Guillermo Tantalean |
|----------------|---|------------|----------------|
| **Edad**       | 19 | **Ciudad** | Lima         |
...
|----------------|---|------------|-------------------|
| **Edad**       | 19 | **Ciudad** | Ica               |
| **Captura de la entrevista** <br> ![image](https://github.com/user-attachments/assets/f0bcfe7d-9a78-4933-aa2f-549d2572ef35) | **Descripción** <br> Guisseppe Gotuzzo menciona que se especializa en la creación de identidades visuales para emprendimientos emergentes. Su enfoque combina la investigación de marca con una ejecución gráfica sólida, utilizando principalmente Adobe Photoshop y Canva como herramientas principales. Aunque ha trabajado en diversos proyectos freelance, reconoce que aún está construyendo una red de contactos sólida que le permita obtener encargos constantes y expandir su portafolio. | 
| **URL de la grabación** | URL: https://shorturl.at/WQtdR | 
|**Timing** | 6:24 - 10:05 |



| **Entrevista** | 3 | **Nombre** | Alvaro Gomez |
|----------------|---|------------|--------------|
| **Edad**       | 19 | **Ciudad** | Ica          |
| **Captura de la entrevista** <br> ![image](https://github.com/user-attachments/assets/f88dba93-15f3-4d1f-88be-e5f71a269529) | **Descripción** <br> Álvaro Gómez se dedica al desarrollo de experiencias digitales, especialmente centradas en la interacción y la usabilidad. Utiliza herramientas como Sketch y InVision para diseñar interfaces web y aplicaciones móviles que sean tanto funcionales como estéticamente atractivas. Su enfoque es siempre centrado en el usuario, y se especializa en la optimización de flujos de navegación. A pesar de su experiencia trabajando con equipos pequeños, le gustaría tener más oportunidades para colaborar en proyectos más grandes y diversificados. | 
| **URL de la grabación** | URL: https://shorturl.at/WQtdR | 
|**Timing** | 10:12 - 15:22 |


## Entrevistas del segmento objetivo: Empresarios 

| **Entrevista** | 4 | **Nombre** | Alejandro Oroncoy |
|----------------|---|------------|--------------------|
| **Edad**       | 20 | **Ciudad** | Lima              |
...
|-----------------|--------|-------------|--------------------------|----------------------------|
| EP-01           | Experiencia del Usuario en la Landing Page  | **Como** visitante **Quiero** tener una experiencia fluida y atractiva en la landing page de la plataforma **Para** que pueda entender fácilmente los beneficios y funcionalidades clave, y tomar una decisión informada sobre registrarme. | - Debe contener una sección destacada que explique los beneficios principales de la plataforma. <br> - El diseño debe ser visualmente atractivo, adaptado a diferentes resoluciones | - |
| US-001          | Navegación Clara  | **Como** visitante interesado en la gestión de residuos <br/> **Quiero** acceder a las secciones clave de la página <br/> **Para** comprender los servicios que ofrece CleanView. | *Escenario 1:* <br/> **"Acceso intuitivo a secciones"** <br/> **Dado que** el visitante accede a la página web <br/> **Cuando** el visitante navega a travéz de ella y quiera derigirse a cada apartado <br/> **Entonces** la página web muestra un menú para redireccionar al visitante <br><br> *Escenario 2:* <br> **Acceso desde distintos dispositivos** <br> **Dado que** el visitante accede a la página desde otro dispositivo <br/> **Cuando** el visitante interactúa con la interfaz para buscar información sobre servicios <br/> **Entonces** la página web adapta su diseño y muestra un menú de navegación accesible con el acceso a las secciones | EP-01 |
| US-002          | Accesos Visibles para Login/Registro | **Como** visitante <br/> **Quiero** registrarme a la aplicación <br/> **Para** acceder a los servicios que ofrecen | *Escenario 1:* <br/> **"Opciónes de registro"** <br/> **Dado que** el visitante se encuentra en la página web <br/> **Cuando** el visitante decea registrarse en la aplicación <br/> **Entonces** la página web muestra accesos de Inicio de sesión y registro. <br><br> *Escenario 2:* <br> **Acceso a la app por segmentos** <br> **Dado que**  el visitante se encuentra en la página web <br/> **Cuando** el visitante decea registrarse en la aplicación <br/> **Entonces** el visitante accede al apartado de registro <br> **Y** el sistema le muestra opciones de registro como empresa y ciudadano | EP-01 |
| US-003           | Comprensión del Valor de la Plataforma | **Como** visitante <br/> **Quiero** entender cómo CleanView me ayuda con la gestión de residuos <br/> **Para** evaluar su implementación | *Escenario 1:* <br/> **"Mensaje claro de beneficios"** <br/> **Dado que** el visitante ingresa a la página web <br/> **Cuando** el visitante lea la sección principal de beneficios <br/> **Entonces** el visitante entiendo el impacto y utilidad de la plataforma <br><br> *Escenario:* <br/> **"Acceso a información institucional"** <br/> **Dado que** el visitante navega por la página web <br/> **Cuando** el visitante va a la sección “Sobre Nosotros” <br/> **Entonces** el visitante obtiene la claridad sobre su el propósito y compromiso ambiental de la empresa | EP-01 |
| US-004             | Accesibilidad a distintos idiomas | **Como** visitante <br/> **Quiero** visualizar la información con el idioma que mejor entienda <br/> **Para** de una forma clara los servicios de la empresa  | *Escenario 1:* <br/> **"Persistencia del idioma seleccionado"** <br/> **Dado que** el visitante está navegando por la página web <br/> **Cuando** el visitante navega entre diferentes secciones de la página o regresa en una visita posterio <br/> **Entonces** el sistema recuerda su selección y muestra automáticamente la página en el idioma elegido sin necesidad de volver a seleccionarlo <br><br> *Escenario 2:* <br> **Selección manual desde el menú** <br> **Dado que**  el visitante se encuentra en la página web <br/> **Cuando** el visitante decea cambiar el idioma de la página <br/> **Entonces** la página web despliega una lista con los idiomas disponibles <br> **Y** la página actualiza automáticamente su contenido al idioma elegido | EP-01 |
| US-005           | Uso de Imágenes y Gráficos Ilustrativos | **Como** visitante <br/> **Quiero** ver ilustraciones del funcionamiento de la app <br/> **Para** comprender su uso y beneficios. | *Escenario 1:* <br/> **"Sección visual informativa"** <br/> **Dado que** el visitante vee las secciones explicativas <br/> **Cuando** el visitante observa las imágenes o gráficos <br/> **Entonces** el visitante comprendo visualmente cómo opera la plataforma. <br><br> *Escenario 2:* <br/> **"Experiencia visual atractiva y fluida"** <br/> **Dado que** el visitante explora la página por primera vez <br/> **Cuando** se desplaza por las secciones que contienen imágenes, íconos animados o gráficos explicativos <br/> **Entonces** el sistema presenta transiciones suaves, efectos visuales moderados y un diseño coherente | EP-01 |
| US-006           | Contacto Directo vía Formulario | **Como** visitante <br/> **Quiero** enviar un mensaje mediante un formulario <br/> **Para** recibir una respuesta del equipo de CleanView | *Escenario 1:* <br/> **"Formulario funcional y directo"** <br/> **Dado que** el visitante tenga una duda o sugerencia <br/> **Cuando** el visitante se diriga a la sección de "Contacto" <br/> **Entonces** la página web muestra un formulario con los datos que el visitante desee compartir <br><br> *Escenario 2:* <br/> **"Confirmación de envío y seguimiento"** <br/> **Dado que** el visitante completa el formulario de contacto y lo envía <br/> **Cuando** el sistema procesa correctamente la solicitud <br/> **Entonces**  el visitante recibe una notificación en pantalla confirmando el envío exitoso | EP-01 |
| US-007 | Visualización de Recompensas Atractiva | **Como** visitante interesado <br/> **Quiero** ver representaciones visuales de las recompensas <br/> **Para** motivarme a participar en el reciclaje con CleanView. | *Escenario:* <br/> **"Motivación visual a través de recompensas"** <br/> **Dado que** llego a la sección de beneficios <br/> **Cuando** veo íconos, premios o puntos mostrados <br/> **Entonces** me siento incentivado a registrarme y participar. | EP-01 |
| US-008 | Información de Recompensas y Reciclaje | **Como** ciudadano comprometido <br/> **Quiero** conocer cómo reciclar correctamente y obtener recompensas <br/> **Para** motivarme a usar la aplicación de forma constante. | *Escenario:* <br/> **"Sección de recompensas visible"** <br/> **Dado que** reviso la página <br/> **Cuando** navego por la sección de reciclaje y puntos <br/> **Entonces** entiendo cómo funciona el sistema de recompensas. | EP-01 |
| US-009           | Chat de soporte ambiental | **Como** visitante <br/> **Quiero** consultar dudas con un asistente virtual <br/> **Para** obtener respuestas sin depender del soporte humano | *Escenario 1:* <br/> **" Comunicación con el asistente virtual en la landing page "** <br/> **Dado que** el visitante visita nuestra pagina web <br/> **Cuando** el visitante selecciona el chat del asistente virtual <br/> **Entonces** el asistente virtual lo saluda con el mensaje e “Hola, ¿Qué te gustaría saber sobre nuestra app?”. <br/><br/> *Escenario 2:* <br/> **" Preguntas frecuentes sobre residuos "** <br/> **Dado que** el visitante visita nuestra pagina web <br/> **Cuando** el visitante selecciona el chat del asistente virtual <br/> **Entonces** el asistente virtual muestra las preguntas frecuentes | EP-01 |
| EP-02           | Monitoreo y Gestión de Residuos en Tiempo Real | **Como** empresario **Quiero** monitorear, recibir alertas y gestionar los residuos en tiempo real mediante sensores y zonas configurables **Para** tomar decisiones rápidas y evitar situaciones críticas o acumulaciones innecesarias de residuos. | - El sistema debe recibir y visualizar datos en tiempo real desde los sensores IoT instalados. <br> - El usuario debe poder configurar zonas de monitoreo desde el panel de control. <br> - Se deben generar alertas automáticas (notificaciones) cuando los niveles de residuos superen un umbral definido. <br> - Las alertas deben indicar claramente la ubicación y tipo de residuo detectado. <br> - El empresario debe poder visualizar gráficos o reportes históricos de generación de residuos. | - |
| US-010           | Monitoreo de residuos en tiempo real | **Como** empresario <br/> **Quiero** visualizar la cantidad y tipo de residuos generados en tiempo real <br/> **Para** tomar decisiones en base a los resultados. | *Escenario 1:* <br/> **"El empresario visualiza el panel de Control"** <br/> **Dado que** el empresario usa la plataforma CleanView. <br/> **Cuando** el empresario accede al panel de monitoreo <br/> **Entonces** el sistema muestra la información del control de residuos en sus almacenes <br/><br/> *Escenario 2:* <br/> **"Visualización de alertas por residuos"** <br/> **Dado que** el empresario usa la plataforma CleanVier. <br/> **Cuando** accede al panel de control. <br/> **Entonces** el sistema detecta un incremento inusual en la generación de residuos. <br> **Y** el sistema genera una alerta automática sobre el problema. <br/><br/> *Escenario 3:* <br/> **"Identificación de los residuos"** <br/> **Dado que** el empresario registrado en la plataforma <br/> **Cuando** el empreserio accede al panel de monitoreo <br/> **Entonces** el sistema detecta un incremento inusual en la generación de residuos. <br> **Y** el sistema me muestra los detalles del residuo  | EP-02 |
| US-011           | Alertas por umbrales críticos | **Como** empresario <br/> **Quiero**     alertas cuando los residuos superen un umbral <br/> **Para** poder tomar decisiones que garanticen el cumplimento ambiental | *Escenario 1:* <br/> **"Notificación de desperdicio crítico"** <br/> **Dado que** el empresario se registra en la app CleanView <br/> **Cuando** el sistema detecta un desperdicio que supera un umbral definido. <br/> **Entonces** el sistema envía una notificación o alerta al correo de la empresa <br/><br/> *Escenario 2:* <br/> **"Configuración de umbrales"** <br/> **Dado que** el empresario se registra en la app CleanView  <br/> **Cuando** el empresario configura un nuevo umbral distinto además de lo legal. <br/> **Entonces** el sistema usa este nuevo umbral para activar alertas  | EP-02 |
| US-012           | Integración con sensores IoT | **Como** empresario <br/> **Quiero** usar sensores inteligentes <br/> **Para** monitoreo automático los residuos | *Escenario 1:* <br/> **” Visualización de residuos por sensor"** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario selecciona "Ver" en la parte de sensores <br/> **Entonces** el sistema muestra la información del sensor y los residuos encontrados. <br/><br/> *Escenario 2:* <br/> **" Registro de un nuevo sensor inteligente"** <br/> **Dado que** el empresario adquiere un nuevo sensor inteligente <br/> **Cuando** el empresario acceda a la sección Panel de Control <br/>**Y** el empresario selecciona en añadir sensores en el sistema.<br/> **Y** el empresario completa los campos requeridos para su instalación.<br/> **Entonces** el sistema guarda el sensor en base de datos. <br/> **Y** el sistema muestra un mensaje de confirmación.<br/><br/> *Escenario 3:* <br/> **" Eliminación de sensor inteligente"** <br/> **Dado que** el empresario adquiere un nuevo sensor inteligente <br/> **Cuando** el empresario acceda a la sección Panel de Control <br/> **Y** el empresario selecciona el botón de “borrar" sección, <br/> **Y** el empresario presiona el icono de tacho al lado del sensor que desea eliminar. <br/> **Entonces** el sistema muestra un mensaje de confirmación para eliminar| EP-02 |
| US-013           | Notificación por tipo de residuo | **Como** empresario <br/> **Quiero** recibir alertas si un tipo específico de residuo aumenta <br/> **Para** mantenerme informado | *Escenario 1:* <br/> **" Generación de alerta por superación de umbral "** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br> **Cuando** el umbral para un tipo de residuo supera el 80% de capacidad. <br/> **Entonces** el sistema genera una alerta y envia por correo electrónico al empresario. | EP-02 |
| US-014           | Añadir nueva zona de monitoreo | **Como** empresario <br/> **Quiero** añadir una nueva zona de monitoreo con sensores <br/> **Para** gestionar los residuos en distintas áreas. | *Escenario 1:* <br/> **"Registro de nueva zona correctamente"** <br/> **Dado que** el empresario crea una nueva zona/almacen para monitorear residuos <br/> **Cuando** el empresario acceda a “Mis Zonas” desde el Panel de Control <br/> **Entonces** el sistema muestra un formulario para añadir la zona de la empresa <br/><br/> *Escenario 2:* <br/> **"Visualización de zona registrada"** <br/> **Dado que** el empresario registra una nueva zona <br/> **Cuando** el usuario acceda a la sección “Mis Zonas” <br/> **Entonces** el sistema muestra la nueva zona en la lista junto con el número de sensores y los datos asignados <br/><br/> *Escenario 3:* <br/> **"Prevención de zonas duplicadas "** <br/> **Dado que** el empresario quiere registrar una nueva zona <br/> **Cuando** el empresario intenta registrar una nueva zona con la misma información <br/> **Entonces** el sistema muestra un mensaje indicando que esa zona ya fue registrada previamente | EP-02 |
| US15           |  Panel de Control y Análisis de Datos  | **Como** empresario, **Quiero** analizar datos de residuos, alertas y zonas,  **Para** tomar decisiones y gestionar mis áreas de monitoreo. | *Escenario 1:* <br/> **"Comparación porcentual"** <br/> **Dado que**  el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario selecciona el periodo que quiere ver los porcentajes <br/> **Entonces** el sistema muestra el porcentaje de incremento o disminución por tipo de residuo respecto al periodo anterior <br><br> *Escenario 2:* <br/> **"Comparación gráfica mensual"** <br/> **Dado que**  el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario selecciona el periodo que quiere ver los porcentajes <br/> **Entonces** el sistema muestra una gráfica comparativa de residuos generados por mes | EP-02 |
| US-016           | Comparación entre periodos | **Como** empresario <br/> **Quiero** comparar residuos entre meses <br/> **Para** identificar patrones de generación de residuos | *Escenario 1:* <br/> **"Comparación gráfica mensual"** <br/> **Dado que** el empresario se registra en la app CleanView <br/> **Cuando** el empresario accede a la página "Panel de Control". <br/> **Entonces** el sistema muestra una gráfica comparativa de residuos generados por mes <br/><br/> *Escenario 2:* <br/> **"Comparación porcentual"** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario selecciona el periodo que quiere ver los porcentajes <br/> **Entonces** el sistema muestra el porcentaje de incremento o disminución por residuo  <br/><br/> *Escenario 3:* <br/> **"Exportación de comparación"** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario finaliza una comparación de residuos <br/> **Entonces** el sistema deberá permitir exportar los resultados del gráfico | EP-02 |
| US-017      | Visualizar gráfico comparativo   | **Como** usuario <br/> **Quiero** ver un gráfico de barras que compare datos entre meses y zonas <br/> **Para** analizar el comportamiento de residuos.                         | *Escenario:* <br/> **"Mostrar gráfico comparativo"** <br/> **Dado que** estoy en el panel de control <br/> **Cuando** cargo la página <br/> **Entonces** veo un gráfico de barras con datos por mes y zona.     | EP-02           |
| TS009       | Añadir Zonas/almacenes mediante RESTful API | **Como** desarrollador <br> **Quiero** añadir un almacen mediante API <br> **Para** que esté disponible al momento de crear funciones en la app | *Escenario 1:* <br/> **" Añadir almacen con un nombre unico "** <br/> **Dado que** el enpoint "/stores" está disponible  <br/> **Cuando** se envie una solicitud de POST con los valores de la entidad almacén <br/> **Entonces** el sistema da una respuesta con estado 201 <br> **Y** el recurso de almacen se incluye en el Body, con un nuevo Id y todos sus valores registrados <br/> **Para** que esté disponible al momento de crear funciones en la app. <br/><br/>  *Escenario 2:* <br/> **" Añadir almacen con un nombre existente "** <br/> **Dado que** el enpoint "/stores" está disponible  <br/> **Cuando** se envie una solicitud de POST con los valores de la entidad almacén <br> **Y** un recurso de almacen ya posee el mismo valor <br/> **Entonces** el sistema da una respuesta con estado 400 <br> **Y** el sistema muestra un mensaje de "A store with the same name already exist" | EP-02 | 
| TS010       | Añadir Sensores mediante RESTful API | **Como** desarrollador <br> **Quiero** añadir un sensor mediante API <br> **Para** que esté disponible al momento de crear funciones en la app | *Escenario 1:* <br/> **" Añadir almacen con un nombre unico "** <br/> **Dado** que el endpoint "/sensors" está disponible <br/> **Cuando** se envíe una solicitud de POST con los valores de la entidad sensor (como tipo, ubicación, estado, etc.) <br/> **Entonces** el sistema da una respuesta con estado 201 <br/> **Y** el recurso de sensor se incluye en el Body, con un nuevo Id y todos sus valores registrados <br/> Para que esté disponible al momento de crear funciones en la app.  | EP-02 |
| TS011       |  Añadir Residuos mediante RESTful API | **Como** desarrollador <br> **Quiero** añadir un residuo mediante API <br> **Para** que esté disponible al momento de crear funciones en la app | *Escenario 1:* <br/> **"Añadir residuo con datos válidos"** <br/> **Dado** que el endpoint "/wastes" está disponible <br/> **Cuando** se envíe una solicitud de publicación con los valores de la entidad residuo (como tipo, cantidad, unidad, ubicación, fecha, etc.) <br/> **Entonces** el sistema da una respuesta con estado 201 <br/> **Y** el recurso de residuo se incluye en el Body, con un nuevo Id y todos sus valores registrados <br/> Para que esté disponible al momento de crear funciones en la app. | EP-02 |
| TS0012       | Actualizar Zonas/almacenes mediante RESTful API | **Como** desarrollador <br> **Quiero** actualizar  un almacen mediante API <br> **Para** que los cambios estén disponibles al momento de crear funciones en la app | *Escenario 1:* <br/> **"Actualizar almacén con datos válidos"** <br/> **Dado que** el enpoint "/stores/{id}" está disponible  <br/> **Cuando** se envie una solicitud PUT con los valores de la entidad almacén <br/> **Entonces** el sistema da una respuesta con estado 200  <br> **Y** el recurso de almacén actualizado se incluye en el Body con sus nuevos valores <br/><br/>  *Escenario 2:* <br/> **" Actualizar  almacen con un ID inexistente "** <br/> **Dado que** el enpoint "/stores/{id}" está disponible  <br/> **Cuando** se envie una solicitud de put con los valores de la entidad almacén <br> **Y** un recurso de almacen no posee ese valor <br/> **Entonces** el sistema da una respuesta con estado 400 <br> **Y** el sistema muestra un mensaje que dicho alamacen no existe | EP-02 | 
| TS0013       | Actualizar Sensores mediante RESTful API | **Como** desarrollador <br> **Quiero** actualizar  un sensor mediante API <br> **Para** que los cambios estén disponibles al momento de crear funciones en la app |  *Escenario 1:* <br/> **"Actualizar almacén con datos válidos"** <br/> **Dado que** el enpoint "/sensors/{id}" está disponible  <br/> **Cuando** se envie una solicitud PUT con los valores de la entidad sensor <br/> **Entonces** el sistema da una respuesta con estado 200  <br> **Y** el recurso de almacén actualizado se incluye en el Body con sus nuevos valores <br/><br/>  *Escenario 2:* <br/> **" Actualizar  sensor con un ID inexistente "** <br/> **Dado que** el enpoint "/sensors/{id}" está disponible  <br/> **Cuando** se envie una solicitud de put con los valores de la entidad sensor <br> **Y** un recurso de sensor no posee ese valor <br/> **Entonces** el sistema da una respuesta con estado 400 <br> **Y** el sistema muestra un mensaje que dicho sensor no existe | EP-02 | 
 | TS0014       | Eliminar Sensores mediante RESTful API | **Como** desarrollador <br> **Quiero** eliminar  un sensor mediante API <br> **Para** que no esté disponibles al momento de crear funciones en la app |  *Escenario 1:* <br/> **"Eliminar  almacén con datos válidos"** <br/> **Dado que** el enpoint "/sensors/{id}" está disponible  <br/> **Cuando** se envie una solicitud DELETE con los valores de la entidad sensor <br/> **Entonces** el sistema da una respuesta con estado 204  <br> **Y**  el sensor es eliminado de la base de datos <br/><br/>  *Escenario 2:* <br/> **" Eliminar  sensor con un ID inexistente "** <br/> **Dado que** el enpoint "/sensors/{id}" está disponible  <br/> **Cuando** se envie una solicitud de DELETE con un ID que no corresponde a ningún sensor existente <br> **Entonces** el sistema da una respuesta con estado 404 <br> **Y** el sistema muestra un mensaje que dicho sensor no existe | EP-02 | 
 | TS-033       | Conexión del Frontend con el Backend para monitoreo de sensores | **Como** desarrolladora Frontend <br> **Quiero** conectar la interfaz con los endpoints de monitoreo de sensores <br> **Para** mostrar en tiempo real el estado de los residuos y generar alertas visuales. | *Escenario 1:* <br/> **"Obtener datos en tiempo real"** <br/> **Dado que** el usuario accede al panel de control <br/> **Cuando** el componente consulta el backend <br/> **Entonces** se muestran los datos actualizados de los sensores. <br/><br/> *Escenario 2:* <br/> **"Error de conexión"** <br/> **Dado que** el backend no responde correctamente <br/> **Cuando** el componente intenta obtener los datos <br/> **Entonces** se muestra un mensaje de error al usuario. | EP-02 |
| EP-03       | Exportación de Reportes Personalizados | **Como** usuario (ciudadano o empresario) <br/> **Quiero** exportar reportes en formato PDF o Excel <br/> **Para** analizarlos fuera del sistema y compartirlos con mi equipo o hacer seguimiento de mis acciones sostenibles. | - El sistema debe permitir la exportación de reportes desde la sección de Panel de Control. <br> - Para empresas, el reporte debe incluir: zona, tipo de residuo, cantidad recolectada (kg) y fecha de última recolección. <br> - Para ciudadanos, el reporte debe incluir: fecha, punto de acopio visitado, tipo de residuo y puntos CleanPoints obtenidos. <br> - El sistema debe ofrecer opciones para filtrar reportes por mes y año antes de exportar. <br> - Los reportes deben poder ser descargados en formato PDF o Excel (.xlsx) según la preferencia del usuario. | - |
| US-18     | Exportación de reportes | **Como** empresario <br/> **Quiero** exportar reportes en PDF o Excel <br/> **Para** analizarlos fuera del sistema y compartirlos con mi equipo | *Escenario 1:* <br/> **"Exportación de reporte"** <br/> **Dado que** el empresario se registra en la app CleanView <br/> **Cuando** el empresario se encuentra en la página de Panel de Control <br/> **Entonces** el empresario seleccione opción “Exportar” <br> **Y** el sistema debe mostrar opciones del formato en el que quiero exportar los datos. <br/><br/> *Escenario 2:* <br/> **" Exportación de reporte en formato PDF "** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario selecciona la opción “PDF” <br/> **Entonces** el sistema genera un archivo pdf con el contenido del reporte <br/><br/> *Escenario 3:* <br/> **" Exportación de reporte en formato EXCEL "** <br/> **Dado que** el empresario se encuentra en la página de Panel de Control <br/> **Cuando** el empresario seleccione la opción “EXCEL” <br/> **Entonces** el sistema genera un archivo .xlsx con los datos tabulados incluyendo fechas y cantidades. | EP-03 |
| US-019     | Exportar reportes para empresas | **Como** empresario <br/> **Quiero** exportar reportes en PDF o Excel <br/> **Para** analizarlos fuera del sistema y compartirlos con mi equipo | *Escenario 1:* <br/> **"Exportar reporte desde panel"** <br/> **Dado que** estoy en la sección de Panel de Control <br/> **Cuando** selecciono la opción “Exportar” <br/> **Entonces** el sistema muestra las opciones de formato y filtros por mes y año. <br/><br/> *Escenario 2:* <br/> **"Exportar en formato PDF"** <br/> **Dado que** selecciono “PDF” como formato <br/> **Cuando** confirmo la exportación <br/> **Entonces** el sistema genera un archivo PDF con zona, tipo de residuo, kg recolectados y última recolección. <br/><br/> *Escenario 3:* <br/> **"Exportar en formato Excel"** <br/> **Dado que** selecciono “Excel” como formato <br/> **Cuando** confirmo la exportación <br/> **Entonces** el sistema genera un archivo .xlsx con los datos tabulados incluyendo zona, tipo de residuo, kg y última recolección. | EP-03 |
| US-020     | Exportar reportes personales | **Como** ciudadano <br/> **Quiero** exportar mi historial de reciclaje <br/> **Para** hacer seguimiento de mi aporte ambiental | *Escenario 1:* <br/> **"Exportar reporte ciudadano"** <br/> **Dado que** me encuentro en la sección de Panel de Usuario <br/> **Cuando** selecciono “Exportar” <br/> **Entonces** el sistema me permite elegir el formato y el periodo (mes/año). <br/><br/> *Escenario 2:* <br/> **"Exportar reporte en PDF"** <br/> **Dado que** elijo el formato PDF <br/> **Cuando** confirmo la exportación <br/> **Entonces** el sistema genera un archivo con fecha, punto de acopio visitado, tipo de residuo y CleanPoints recolectados. <br/><br/> *Escenario 3:* <br/> **"Exportar reporte en Excel"** <br/> **Dado que** elijo el formato Excel <br/> **Cuando** confirmo la exportación <br/> **Entonces** el sistema genera un archivo .xlsx con las mismas columnas y datos tabulados. | EP-03 |
| US-021     | Filtrar reportes por periodo | **Como** usuario <br/> **Quiero** seleccionar un mes y año para exportar los datos <br/> **Para** enfocarme en un periodo específico de recolección o reciclaje | *Escenario:* <br/> **"Filtrado por periodo"** <br/> **Dado que** estoy en la opción de exportación de reportes <br/> **Cuando** selecciono un mes y un año <br/> **Entonces** el sistema genera un archivo solo con los datos correspondientes al periodo indicado. | EP-03 |
| US-022     | Visualizar reporte antes de exportar | **Como** usuario <br/> **Quiero** ver una vista previa del reporte <br/> **Para** asegurarme de que la información es correcta antes de descargar | *Escenario:* <br/> **"Vista previa de reporte"** <br/> **Dado que** selecciono filtros de exportación <br/> **Cuando** visualizo la sección del historial de participacion o de recojo <br/> **Entonces** el sistema me muestra una parte de los datos que serán incluidos en el archivo. | EP-03 |
| EP-04 | Acciones Sostenibles y Comunidad | **Como** usuario **Quiero** acceder, filtrar, comentar, marcar como favorito y compartir tips sobre sostenibilidad **Para** fomentar buenas prácticas ambientales, conectarme con la comunidad y motivar hábitos responsables. | - El usuario debe poder filtrar los tips por categoría de residuo y el sistema debe actualizar dinámicamente los resultados. <br> - Se debe permitir al usuario marcar tips como favoritos y que se vean primeros en la sección. <br> - El usuario debe poder comentar en los tips para compartir experiencias o recomendaciones. <br> - El sistema debe permitir ganar puntos por interacciones sostenibles y canjearlos por recompensas al llevar residuos a puntos de acopio. | - |
| US-23           | Consejos para manejo de residuos | **Como** ciudadano <br/> **Quiero** recibir consejos del cuidado ambiental y reciclaje <br/> **Para** reducir residuos en casa.  | *Escenario 1:* <br/> **"Acceder a consejos desde la app"** <br/> **Dado que** el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano entre a la sección de “Acciones Sostenibles”. <br/> **Entonces** el sistema muestre una lista de recomendaciones sobre reciclaje actualizadas y categorizadas. <br/><br/> *Escenario 2:* <br/> **"Filtrar por tipo de consejo "** <br/> **Dado que** el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano entre a la sección de “Acciones Sostenibles” <br/> **Entonces** el sistema permite buscar consejos de reciclaje por categoría de residuos <br/> **Y** el sistema muestra consejos relacionados a esa categoría <br/><br/> *Escenario 3:* <br/> **"Guardar consejos favoritos"** <br/> **Dado que** el ciudadano entre a la sección de “Acciones Sostenibles” <br/> **Cuando** el ciudadano le gusta un consejo y lo marca como favorito <br/> **Entonces** el sistema lo guarda y puede verlo las veces que desee | EP-04 |
| US-024           | Sistema de insignias por logros sostenibles | **Como** ciudadano <br/> **Quiero** recibir insignias por hitos alcanzados <br/> **Para** motivarme a seguir con mis logros | *Escenario 1:* <br/> **"Insignia por reducción de residuos"** <br/> **Dado que** el ciudadano logra reducir un cierto porcentaje de residuos en un período <br/> **Cuando** el ciudadano cumpla la meta de recolección dada <br/> **Entonces** el sistema le otorga automáticamente una insignia <br/><br/> *Escenario 2:* <br/> **" Visualización de insignias obtenidas"** <br/> **Dado que** he ganado varias insignias. <br/> **Cuando** accedo a mi perfil. <br/> **Entonces** debo poder ver una lista con las insignia que obtuve junto a sus detalles. <br/><br/> *Escenario 3:* <br/> **"  Comparte tus logros "** <br/> **Dado que** valoro el reconocimiento. <br/> **Cuando**  obtenga una nueva insignia. <br/> **Entonces** CleanWind debo poder compartirlo en redes sociales. | EP-04  |
| US-025           | Gamificación ecológica | **Como** ciudadano <br/> **Quiero** recibir puntos por buenas prácticas de reciclaje <br/> **Para** motivarme a seguir usando la app  | *Escenario 1:* <br/> **"Acumulación automatica de puntos"** <br/> **Dado que**  el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano realiza una acción ecológica <br/> **Entonces**  el sistema la valida <br> **Y** el sistema asigna puntos automáticamente <br/><br/> *Escenario 2:* <br/> **"Ver historial de puntos"** <br/> **Dado que** el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano ingresa a la sección "Recompensas" <br/> **Entonces** el sistema muestro los puntos ganados y acumulados. <br/><br/> *Escenario 3:* <br/> **"Canjear puntos por beneficios”** <br/> **Dado que** el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano ingrese a la sección "Recompensas" <br/> **Entonces** el sitema le permite canjear los puntos que he estado ganando con los puntos que ha acumulado. | EP-04 |
| US-026           | Registro de acciones sostenibles | **Como** ciudadano <br/> **Quiero** registrar una acción sostenible  <br/> **Para** contribuir al cuidado ambiental  | *Escenario 1:* <br/> **"Acceder al formulario de registro"** <br/> **Dado que**  el cuidadano esta registrado en la app <br/> **Cuando** el ciudadano entra a la sección de “Acciones Sostenibles” y presiona el botón de agregar acción sostenible<br/> **Entonces**  el sistema muestra un formulario para ingresar título, descripción y tipo de acción sostenible <br/><br/> *Escenario 2:* <br/> **"Registrar la acción** <br/> **Dado que** que el ciudadano ha llenado correctamente el formulario <br/> **Cuando** presiona el botón “Guardar” <br/> **Entonces** el sistema registra la acción y la agrega a la lista de acciones sostenibles visibles| EP-04 |
| **TS015** | Añadir Acción Sostenible mediante RESTful API | **Como** desarrollador <br> **Quiero** añadir una acción sostenible mediante API <br> **Para** que esté disponible al momento de gestionar acciones sostenibles en la app | **Escenario 1:** <br/> **" Añadir acción sostenible válida "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions está disponible <br/> **Cuando** se envíe una solicitud POST con los valores de la entidad acción sostenible (título, descripción, tipo válido y favorito) <br/> **Entonces** el sistema da una respuesta con estado 201 <br/> **Y** el recurso de acción sostenible se incluye en el body, con un nuevo id y todos sus valores registrados <br/><br/> **Escenario 2:** <br/> **" Añadir acción sostenible sin tipo válido "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions está disponible <br/> **Cuando** se envíe una solicitud POST sin el tipo válido o ausente <br/> **Entonces** el sistema da una respuesta con estado 400 <br/> **Y** el sistema incluye un mensaje indicando que el tipo es obligatorio | **EP-04** |
| **TS016** | Obtener Todas las Acciones Sostenibles mediante RESTful API | **Como** desarrollador <br> **Quiero** obtener todas las acciones sostenibles mediante API <br> **Para** que sean listadas correctamente en la app | **Escenario:** <br/> **" Obtener lista completa de acciones sostenibles "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions está disponible <br/> **Cuando** se envíe una solicitud GET <br/> **Entonces** el sistema da una respuesta con estado 200 <br/> **Y** el body incluye la lista completa de acciones sostenibles registradas | **EP-04** |
| **TS017** | Obtener Acciones Sostenibles filtradas por Tipo mediante RESTful API | **Como** desarrollador <br> **Quiero** obtener acciones sostenibles filtradas por tipo mediante API <br> **Para** que sean consultadas por su tipo cuando sea necesario | **Escenario:** <br/> **" Obtener acciones sostenibles filtradas por tipo válido "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions/type/{type} está disponible <br/> **Cuando** se envíe una solicitud GET con un tipo válido (e.g. "STORAGE") <br/> **Entonces** el sistema da una respuesta con estado 200 <br/> **Y** el body incluye la lista de acciones sostenibles filtradas por tipo | **EP-04** |
| **TS018** | Obtener Tipos de Acciones Sostenibles mediante RESTful API | **Como** desarrollador <br> **Quiero** obtener todos los tipos de acciones sostenibles mediante API <br> **Para** que sean listados en un selector de tipo en la app | **Escenario:** <br/> **" Obtener lista de tipos sostenibles "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions/types está disponible <br/> **Cuando** se envíe una solicitud GET <br/> **Entonces** el sistema da una respuesta con estado 200 <br/> **Y** el body incluye la lista de tipos sostenibles válidos (e.g. STORAGE, OPERATIONAL, REGULATION) | **EP-04** |
| **TS019** | Eliminar Acción Sostenible mediante RESTful API | **Como** desarrollador <br> **Quiero** eliminar una acción sostenible mediante API <br> **Para** que los registros obsoletos sean removidos correctamente de la app | **Escenario:** <br/> **" Eliminar acción sostenible existente por id "** <br/> **Dado que** el endpoint /api/v1/sustainable-actions/{id}` está disponible <br/> **Cuando** se envíe una solicitud DELETE con el id válido <br/> **Entonces** el sistema da una respuesta con estado 200 <br/> **Y** el recurso es eliminado correctamente | **EP-02** |
| TS-032 | Conexión frontend-backend para visualización de Tips sostenibles | Establecer la conexión entre el frontend en Angular y el backend en Spring Boot para obtener y mostrar Tips sostenibles en la interfaz de usuario. | - *Escenario 1: Obtención de tips exitosamente*<br>**Dado que** el usuario accede a la vista de Tips<br>**Cuando** se realiza una solicitud al backend<br>**Entonces** se recibe una lista de tips sostenibles y se muestra correctamente en pantalla.<br><br>- *Escenario 2: Fallo en la conexión*<br>**Dado que** hay un error en la API o en la red<br>**Entonces** se muestra un mensaje de error al usuario. | EP-02 |
...
| US-028           | Contratación de servicios de recolección | **Como** empresa <br/> **Quiero** contratar servicios de recolección de residuos <br/> **Para** asegurar el recojo eficiente | *Escenario 1:* <br/> **"Selección de proveedor de recolección "** <br/> **Dado que** el empresario se regitra en la app de CleanView <br/> **Cuando** el empresario ingresa a la sección de puntos de acopio <br/> **Entonces** el empresario busca la empresa que mejor se acomode a sus necesidades <br> **Y** el sistema permite contratar un servicio de una empresa de reciclaje <br/><br/> *Escenario 2:* <br/> **" Visualización del estado de contrato"** <br/> **Dado que** el empresario contrata un servicio de recolección <br> **Cuando** el empresario accede a “Mis servicios contratados” desde la página de puntos de acopio <br/> **Entonces** el sistema muestra la información de la empresa recolectora <br/><br/> *Escenario 3:* <br/> **"Cancelación de servicio de recolección"** <br/> **Dado que** el empresario esta en la página de puntos de acopio <br/> **Cuando** el empresario visualiza el apartado de “Mis servicios contratados” <br/> **Entonces** el sistema ofrece eliminar el contrato de un sevicio | EP-05 |
| US-029           | Puntos de reciclaje cercanos | **Como** ciudadano <br/> **Quiero** ver puntos de reciclaje cerca de mi casa <br/> **Para** llevar residuos a reciclar | *Escenario 1:* <br/> **"Visualizar puntos cercanos automáticamente"** <br/> **Dado que** el ciudadano ingrese a la aplicación con permisos de ubicación activados <br/> **Cuando** el ciudadano seleccione la opcion puntos de acopio <br/> **Entonces** el sistema le muestra un mapa con los puntos de reciclaje más cercanos <br/><br/> *Escenario 2:* <br/> **"Busca por dirección o distrito"** <br/> **Dado que** el ciudadano ingrese a la aplicación con permisos de ubicación activados <br/> **Cuando** el ciudadano escribe una dirección o nombre de distrito. <br/> **Entonces** el sistema muestra los puntos de reciclaje cercanos a esa ubicación <br/><br/> *Escenario 3:* <br/> **"Ver detalles de un punto"** <br/> **Dado que** el ciudadano ingrese a la aplicación con permisos de ubicación activados <br/> **Cuando** el ciudadano vee un punto de reciclaje en el mapa y haga click sobre él. <br/> **Entonces** el sistema muestra la dirección, horario y tipo de materiales aceptados de dicho punto | EP-05 |
| US-030 | Filtrar puntos de acopio por tipo de residuo o distrito | **Como** usuario <br/> **Quiero** filtrar los puntos de acopio <br/> **Para** encontrar los que se ajustan a mis necesidades. | *Escenario 1:* <br/> **"Filtrado por tipo de residuo"** <br/> **Dado que** estoy en la sección de puntos de acopio <br/> **Cuando** selecciono un tipo de residuo <br/> **Entonces** la lista muestra únicamente los puntos que aceptan ese tipo. <br><br> *Escenario 2:* <br/> **"Filtrado por distrito"** <br/> **Dado que** estoy en la sección de puntos de acopio <br/> **Cuando** selecciono un distrito en el filtro <br/> **Entonces** la lista se actualiza mostrando solo los puntos de acopio ubicados en ese distrito. | EP-05 |
| US-031          | Ver mapa con ubicación de los puntos                    | **Como** usuario <br/> **Quiero** ver los puntos de acopio en un mapa <br/> **Para** ubicar fácilmente el más cercano.                                | *Escenario:* <br/> **"Visualización geográfica"** <br/> **Dado que** estoy en la vista de mapa <br/> **Cuando** se carga la página <br/> **Entonces** veo marcadores en el mapa según la ubicación de cada punto.  | EP-05                     |
...
| TS020 | Implementar endpoint para listar puntos de acopio                 | Crear un endpoint REST que devuelva todos los puntos de acopio registrados, con información como nombre, horario, teléfono, materiales y coordenadas.       | - Escenario 1: Listado exitoso<br>Dado una solicitud GET válida al endpoint<br>Cuando existen puntos registrados<br>Entonces se debe responder con una lista de puntos y código HTTP 200.<br><br>- Escenario 2: Lista vacía<br>Dado que no existen puntos de acopio registrados<br>Entonces se responde con una lista vacía y código HTTP 200.                                                        |  EP-05    |
| TS021 | Implementar endpoint para registrar un nuevo punto de acopio      | Crear un endpoint REST que permita registrar un nuevo punto de acopio con datos como nombre, horario, teléfono, materiales reciclables y ubicación.         | - Escenario 1: Registro exitoso<br>Dado que se envía una solicitud POST con datos válidos<br>Cuando el backend procesa correctamente los datos<br>Entonces debe responder con código HTTP 201 y la ubicación del recurso.<br><br>- Escenario 2: Datos inválidos<br>Dado una solicitud con datos faltantes o incorrectos<br>Entonces se debe responder con un código HTTP 400 y mensaje de validación. |  EP-05    |
| TS022 | Implementar endpoint para detalle de punto de acopio              | Crear un endpoint que permita consultar los detalles de un punto de acopio específico por ID para mostrar información completa en el frontend.              | - Escenario 1: Consulta exitosa<br>Dado un ID válido en la solicitud GET<br>Cuando el punto existe<br>Entonces el backend debe responder con los datos del punto y código HTTP 200.<br><br>- Escenario 2: Punto no encontrado<br>Dado un ID inexistente<br>Entonces debe responder con código HTTP 404 y un mensaje informativo.                                                                      |  EP-05    |
| TS023 | Implementar endpoint para eliminar punto de acopio                | Crear un endpoint REST que permita eliminar un punto de acopio existente por su ID, asegurando que ya no sea visible ni en la lista ni en el mapa.          | - Escenario 1: Eliminación exitosa<br>Dado un ID válido en la solicitud DELETE<br>Cuando el punto existe<br>Entonces se elimina y se responde con código HTTP 204.<br><br>- Escenario 2: Punto no encontrado<br>Dado un ID inexistente<br>Entonces debe responder con código HTTP 404 y mensaje correspondiente.                                                                                      |  EP-05    |
| TS024 | Implementar endpoint para actualizar datos de punto de acopio     | Crear un endpoint REST que permita modificar los datos de un punto de acopio registrado, permitiendo cambios en horario, materiales o ubicación.            | - Escenario 1: Actualización exitosa<br>Dado un ID válido y datos correctos en una solicitud PUT<br>Cuando el punto existe<br>Entonces se debe actualizar la información y responder con código HTTP 200.<br><br>- Escenario 2: Punto no encontrado<br>Dado un ID inexistente<br>Entonces se responde con código HTTP 404.                                                                            |  EP-05    |
| TS025 | Implementar API para mostrar pines en el mapa interactivo         | Crear un endpoint que devuelva los puntos de acopio con coordenadas geográficas (latitud y longitud) para renderizar pines en un mapa con Leaflet.          | - Escenario 1: Mapa con pines cargados<br>Dado una solicitud GET al endpoint<br>Cuando existen puntos registrados<br>Entonces debe responder con la lista incluyendo coordenadas y código HTTP 200.<br><br>- Escenario 2: Mapa sin pines<br>Dado que no existen puntos registrados<br>Entonces se debe responder con una lista vacía y código HTTP 200.                                               |  EP-05    |
| TS026 | Implementar endpoint para filtrar puntos por tipo de material     | Crear un endpoint que permita aplicar filtros por tipo de material reciclable (ej. plástico, papel) para mostrar resultados tanto en lista como en el mapa. | - Escenario 1: Filtro exitoso<br>Dado un tipo de material válido en una solicitud GET con query param<br>Cuando existen puntos que aceptan ese material<br>Entonces se responde con una lista filtrada y código HTTP 200.<br><br>- Escenario 2: Filtro sin resultados<br>Dado un tipo de material sin coincidencias<br>Entonces se responde con una lista vacía y código HTTP 200.                    |  EP-05    |
| TS027 | Implementar endpoint para búsqueda de puntos de acopio por nombre | Crear un endpoint que permita buscar puntos de acopio por nombre o parte del nombre, facilitando la ubicación rápida de un punto específico.                | - Escenario 1: Búsqueda exitosa<br>Dado un término de búsqueda válido<br>Cuando hay coincidencias por nombre<br>Entonces se devuelve una lista filtrada y código HTTP 200.<br><br>- Escenario 2: Búsqueda sin coincidencias<br>Dado un término sin resultados<br>Entonces se devuelve lista vacía y código HTTP 200.                                                                                  |  EP-05    |
| EP-06  | Gestión de Autenticación                   | **Como** nuevo usuario o usuario registrado <br/> **Quiero** poder registrarme e iniciar sesión de forma segura <br/> **Para** acceder a las funcionalidades de CleanView | - El sistema debe permitir el registro de nuevos usuarios con nombre, correo, contraseña y rol. <br/> - El sistema debe validar los datos de acceso y permitir el inicio de sesión con correo y contraseña. <br/> - El sistema debe devolver un token JWT al autenticarse correctamente. <br/> - El sistema debe gestionar los roles ('PERSON', 'COMPANY') al momento de registro. <br/> - Los errores deben mostrarse claramente al usuario. | - |
| US-033   | Registro de nuevos usuarios                      | **Como** visitante <br/> **Quiero** registrarme proporcionando mi nombre, correo, contraseña y rol <br/> **Para** empezar a usar la plataforma CleanView                      | *Escenario 1:* <br/> **"Registro exitoso"** <br/> **Dado que** el visitante llena todos los campos del formulario correctamente <br/> **Cuando** hace clic en el botón de registro <br/> **Entonces** se crea una nueva cuenta y es redirigido a la pantalla de inicio de sesión. <br/><br/>*Escenario 2:* <br/> **"Error por datos inválidos"** <br/> **Dado que** el visitante no llena los campos requeridos o proporciona datos inválidos <br/> **Entonces** el sistema muestra mensajes de error específicos (e.g. correo inválido, contraseña vacía). | EP-06 |
| US-034   | Inicio de sesión para usuarios registrados       | **Como** usuario registrado <br/> **Quiero** ingresar mis credenciales <br/> **Para** acceder al panel de usuario y funcionalidades de la aplicación                          | *Escenario 1:* <br/> **"Inicio exitoso"** <br/> **Dado que** el usuario proporciona un correo y contraseña válidos <br/> **Cuando** presiona el botón "Iniciar Sesión" <br/> **Entonces** el sistema lo redirige a la pantalla de inicio. <br/><br/>*Escenario 2:* <br/> **"Credenciales inválidas"** <br/> **Dado que** el usuario ingresa datos incorrectos <br/> **Entonces** se muestra un mensaje de error de autenticación. | EP-06 |
| TS-028   | Endpoint para registro de usuarios (`/sign-up`)        | Crear un endpoint REST que permita registrar nuevos usuarios incluyendo nombre, correo, contraseña y rol (‘COMPANY’, ‘PERSON’).                                          | - *Escenario 1: Registro exitoso*<br>**Dado que** se recibe una solicitud POST con datos válidos<br>**Cuando** el backend procesa correctamente los datos<br>**Entonces** se responde con código HTTP 201 y los datos del usuario creado.<br><br>- *Escenario 2: Datos inválidos*<br>**Dado** que la solicitud tiene campos vacíos o inválidos<br>**Entonces** el sistema responde con código HTTP 400 y mensaje de validación.<br><br>- *Escenario 3: Usuario ya existente*<br>**Entonces** devuelve código 409 y mensaje de conflicto. | EP-06 |
| TS-029   | Endpoint para inicio de sesión (`/sign-in`)            | Crear un endpoint REST que reciba correo y contraseña, valide credenciales, y devuelva un token y los datos del usuario si son correctos.                               | - *Escenario 1: Inicio exitoso*<br>**Dado que** se recibe una solicitud POST con credenciales válidas<br>**Cuando** el usuario existe y la contraseña es correcta<br>**Entonces** se responde con código HTTP 200, un token y los datos del usuario.<br><br>- *Escenario 2: Usuario no encontrado o contraseña incorrecta*<br>**Entonces** devuelve HTTP 404 o 401 con mensaje de error.<br><br>- *Escenario 3: Campos incompletos*<br>**Entonces** devuelve HTTP 400.                              | EP-06 |
| TS-030   | Persistencia de token y usuario en frontend            | Implementar almacenamiento del token JWT y datos del usuario en `localStorage` tras un inicio de sesión exitoso.                                                         | - *Escenario 1: Almacenar token*<br>**Dado que** el backend responde con token válido<br>**Entonces** el frontend lo guarda en `localStorage` y actualiza el estado actual del usuario.<br><br>- *Escenario 2: Recuperar usuario activo*<br>**Dado** que el usuario ha iniciado sesión previamente<br>**Entonces** la app recupera el usuario desde el almacenamiento y lo mantiene como sesión activa.                                                                                  | EP-06 |
| TS-031   | Componente frontend para formulario de login/register | Implementar los formularios con Angular para el inicio de sesión y registro, conectados al backend, incluyendo validaciones visuales y redirección tras éxito.          | - *Escenario 1: Mostrar errores de validación*<br>**Dado que** el usuario deja campos vacíos<br>**Entonces** se muestra un mensaje debajo del campo afectado.<br><br>- *Escenario 2: Redirección tras login exitoso*<br>**Entonces** el usuario es redirigido a `/home`.<br><br>- *Escenario 3: Redirección tras registro exitoso*<br>**Entonces** el usuario es redirigido a la vista de login.                                                                                             | EP-06 |
| EP-07 | Modelado Técnico de CleanView | **Como** desarrollador <br/> **Quiero** modelar los componentes técnicos de la aplicación (C4, clases y base de datos) <br/> **Para** asegurar una arquitectura robusta y coherente con los requisitos funcionales | - Se debe construir un diagrama C4 que describa los niveles Contexto, Contenedor y Componentes de CleanView. <br/> - Se debe diseñar un modelo de clases con entidades coherentes con la lógica del dominio. <br/> - Se debe modelar una base de datos relacional acorde a las entidades del sistema. <br/> - El modelo debe reflejar la separación entre usuarios personales y empresariales, así como la relación entre sensores, almacenes y residuos. | - |
| US-035  | Crear diagrama C4 de CleanView             | **Como** desarrollador <br/> **Quiero** diseñar un diagrama C4 <br/> **Para** representar los niveles de abstracción de CleanView           | *Escenario:* <br/> **"Diseño de niveles C4"** <br/> **Dado que** tengo una visión general del sistema <br/> **Cuando** documento los niveles Contexto, Contenedor y Componentes <br/> **Entonces** el equipo tiene claridad sobre cómo interactúan los actores, los módulos principales y los servicios internos de CleanView | EP-07 |
| US-036  | Modelar clases principales del sistema      | **Como** desarrollador <br/> **Quiero** construir un diagrama de clases <br/> **Para** organizar las entidades del dominio de CleanView      | *Escenario:* <br/> **"Diseño de entidades"** <br/> **Dado que** el sistema gestiona usuarios, sensores, residuos, contratos, etc. <br/> **Cuando** creo clases con sus atributos y relaciones <br/> **Entonces** se genera un modelo coherente que se usará como base para la lógica de negocio | EP-07 |
| US-037  | Diseñar el modelo relacional de base de datos | **Como** desarrollador <br/> **Quiero** construir el modelo ER de CleanView <br/> **Para** asegurar la persistencia estructurada de datos | *Escenario:* <br/> **"Modelo físico de BD"** <br/> **Dado que** el sistema requiere almacenar sensores, almacenes, usuarios, residuos, etc <br/> **Cuando** defino las tablas, claves primarias/foráneas y relaciones <br/> **Entonces** obtengo un esquema de base de datos listo para su implementación relacional | EP-07 |
| US-038  | Documentar relaciones entre entidades       | **Como** desarrollador <br/> **Quiero** registrar las relaciones entre las clases y tablas <br/> **Para** facilitar la implementación posterior | *Escenario:* <br/> **"Documentación estructural"** <br/> **Dado que** los diagramas están diseñados <br/> **Cuando** detallo las herencias, composiciones y asociaciones <br/> **Entonces** los desarrolladores pueden implementar los modelos con fidelidad y bajo acoplamiento | EP-07 |
...
| 9     | US-035         | Crear diagrama C4 de CleanView             | Como desarrollador<br/>Quiero diseñar un diagrama C4<br/>Para representar los niveles de abstracción de CleanView           | 5 |
| 10    | US-036         | Modelar clases principales del sistema      | Como desarrollador<br/>Quiero construir un diagrama de clases<br/>Para organizar las entidades del dominio de CleanView      | 5 |
| 11    | US-037         | Diseñar el modelo relacional de base de datos | Como desarrollador<br/>Quiero construir el modelo ER de CleanView<br/>Para asegurar la persistencia estructurada de datos | 5 |
| 12    | US-038         | Documentar relaciones entre entidades       | Como desarrollador<br/>Quiero registrar las relaciones entre las clases y tablas<br/>Para facilitar la implementación posterior | 3 |
| 13    | US-010         | Monitoreo de residuos en tiempo real          | Como empresario<br/>Quiero visualizar la cantidad y tipo de residuos generados en tiempo real<br/>Para tomar decisiones en base a los resultados.          | 8 |
| 14    | US-011         | Alertas por umbrales críticos                 | Como empresario<br/>Quiero alertas cuando los residuos superen un umbral<br/>Para poder tomar decisiones que garanticen el cumplimiento ambiental          | 5 |
| 15    | US-013         | Notificación por tipo de residuo              | Como empresario<br/>Quiero recibir alertas si un tipo específico de residuo aumenta<br/>Para mantenerme informado                                           | 3 |
| 16    | US-012         | Integración con sensores IoT                  | Como empresario<br/>Quiero usar sensores inteligentes<br/>Para monitoreo automático de los residuos                                                        | 8 |
| 17    | US-014         | Añadir nueva zona de monitoreo                | Como empresario<br/>Quiero añadir una nueva zona de monitoreo con sensores<br/>Para gestionar los residuos en distintas áreas                              | 5 |
| 18    | US15           | Panel de Control y Análisis de Datos          | Como empresario, Quiero analizar datos de residuos, alertas y zonas, Para tomar decisiones y gestionar mis áreas de monitoreo                              | 8 |
| 19    | US-016         | Comparación entre periodos                    | Como empresario<br/>Quiero comparar residuos entre meses<br/>Para identificar patrones de generación de residuos                                           | 5 |
| 20    | US-017         | Visualizar gráfico comparativo                | Como usuario<br/>Quiero ver un gráfico de barras que compare datos entre meses y zonas<br/>Para analizar el comportamiento de residuos                     | 3 |
| 21    | US-018         | Exportación de reportes                       | Como empresario<br/>Quiero exportar reportes en PDF o Excel<br/>Para analizarlos fuera del sistema y compartirlos con mi equipo                           | 5 |
| 22    | US-019         | Exportar reportes para empresas               | Como empresario<br/>Quiero exportar reportes en PDF o Excel<br/>Para analizarlos fuera del sistema y compartirlos con mi equipo                           | 5 |
| 23    | US-020         | Exportar reportes personales                  | Como ciudadano<br/>Quiero exportar mi historial de reciclaje<br/>Para hacer seguimiento de mi aporte ambiental                                             | 5 |
| 24    | US-021         | Filtrar reportes por periodo                  | Como usuario<br/>Quiero seleccionar un mes y año para exportar los datos<br/>Para enfocarme en un periodo específico de recolección o reciclaje           | 3 |
| 25    | US-022         | Visualizar reporte antes de exportar          | Como usuario<br/>Quiero ver una vista previa del reporte<br/>Para asegurarme de que la información es correcta antes de descargar                         | 3 |
| 26    | US-023         | Consejos para manejo de residuos              | Como ciudadano<br/>Quiero recibir consejos del cuidado ambiental y reciclaje<br/>Para reducir residuos en casa                                             | 3 |
| 27    | US-026         | Registro de acciones sostenibles              | Como ciudadano<br/>Quiero registrar una acción sostenible<br/>Para contribuir al cuidado ambiental                                                         | 3 |
| 28    | US-025         | Gamificación ecológica                        | Como ciudadano<br/>Quiero recibir puntos por buenas prácticas de reciclaje<br/>Para motivarme a seguir usando la app                                       | 5 |
| 29    | US-024         | Sistema de insignias por logros sostenibles  | Como ciudadano<br/>Quiero recibir insignias por hitos alcanzados<br/>Para motivarme a seguir con mis logros                                               | 5 |
| 30    | US-027         | Ofrecer un servicio de recolección           | Como empresario<br/>Quiero ofrecer el servicio de recolección de mi empresa<br/>Para poder reciclar más residuos y generar ingresos                       | 8 |
| 31    | US-028         | Contratación de servicios de recolección     | Como empresa<br/>Quiero contratar servicios de recolección de residuos<br/>Para asegurar el recojo eficiente                                               | 8 |
| 32    | US-029         | Puntos de reciclaje cercanos                 | Como ciudadano<br/>Quiero ver puntos de reciclaje cerca de mi casa<br/>Para llevar residuos a reciclar                                                    | 5 |
| 33    | US-030         | Filtrar puntos de acopio por tipo o distrito | Como usuario<br/>Quiero filtrar los puntos de acopio<br/>Para encontrar los que se ajustan a mis necesidades                                               | 3 |
| 34    | US-031         | Ver mapa con ubicación de los puntos         | Como usuario<br/>Quiero ver los puntos de acopio en un mapa<br/>Para ubicar fácilmente el más cercano                                                     | 5 |
| 35    | US-032         | Añadir nuevo punto de acopio                 | Como administrador<br/>Quiero registrar nuevos puntos de acopio<br/>Para ampliar la red disponible para los usuarios                                      | 5 |
| 36    | US-002         | Accesos Visibles para Login/Registro        | Como visitante<br/>Quiero registrarme a la aplicación<br/>Para acceder a los servicios que ofrecen                                                        | 3 |
| 37    | TS009          | Implementar endpoint para listar puntos de acopio | Como desarrollador<br/>Quiero añadir un almacen mediante API<br/>Para que esté disponible al momento de crear funciones en la app | 5 |
| 38    | TS010          | Añadir Sensores mediante RESTful API | Como desarrollador<br/>Quiero añadir un sensor mediante API<br/>Para que esté disponible al momento de crear funciones en la app | 5 |
| 39    | TS011          | Añadir Residuos mediante RESTful API | Como desarrollador<br/>Quiero añadir un residuo mediante API<br/>Para que esté disponible al momento de crear funciones en la app | 5 |
| 40    | TS012          | Actualizar Zonas/almacenes mediante RESTful API | Como desarrollador<br/>Quiero actualizar un almacen mediante API<br/>Para que los cambios estén disponibles al momento de crear funciones en la app | 3 |
| 41    | TS013          | Actualizar Sensores mediante RESTful API  | Como desarrollador<br/>Quiero actualizar un sensor mediante API<br/>Para que los cambios estén disponibles al momento de crear funciones en la app | 3 |
| 42    | TS014          | Eliminar Sensores mediante RESTful API  | Como desarrollador<br/>Quiero eliminar un sensor mediante API<br/>Para que no esté disponible al momento de crear funciones en la app | 3 |
| 43    | TS015          | Añadir Acción Sostenible mediante RESTful API  | Como desarrollador<br/>Quiero añadir una acción sostenible mediante API<br/>Para que esté disponible al momento de gestionar acciones sostenibles en la app | 5 |
| 44    | TS016          | Obtener Todas las Acciones Sostenibles mediante RESTful API | Como desarrollador<br/>Quiero obtener todas las acciones sostenibles mediante API<br/>Para que sean listadas correctamente en la app | 3 |
| 45    | TS017          | Obtener Acciones Sostenibles filtradas por Tipo mediante RESTful API  | Como desarrollador<br/>Quiero obtener acciones sostenibles filtradas por tipo mediante API<br/>Para que sean consultadas por su tipo cuando sea necesario | 5 |
| 46    | TS018          | Obtener Tipos de Acciones Sostenibles mediante RESTful API  | Como desarrollador<br/>Quiero obtener todos los tipos de acciones sostenibles mediante API<br/>Para que sean listados en un selector de tipo en la app | 3 |
| 47    | TS019          | Eliminar Acción Sostenible mediante RESTful API  | Como desarrollador<br/>Quiero eliminar una acción sostenible mediante API<br/>Para que los registros obsoletos sean removidos correctamente de la app | 3 |
...
| **US-046**      | Diagrama C4 de CleanView                   | **TA030**   | Modelar el nivel de Contexto y Contenedores de CleanView, mostrando los principales actores y sistemas.           | 2 horas                | Renzo Sebastian Uribe Livia              | Done       |
|                 |                                             | **TA031**   | Definir los contenedores internos (Frontend, Backend, DB) y sus relaciones en el nivel de Contenedores.           | 1.5 horas              | Renzo Sebastian Uribe Livia              | Done       |
| **US-047**      | Modelado de clases del sistema             | **TA032**   | Diseñar el diagrama de clases con herencia entre Identity, NaturalUser y BusinessUser.                            | 1.5 horas              | Gabriel Fernando Gordon Salas            | Done       |
|                 |                                             | **TA033**   | Representar las relaciones entre entidades como Sensor, Store, TipMessage y RedeemableReward.                     | 1.5 horas              | Gabriel Fernando Gordon Salas            | Done       |

| **US-048**      | Diseño de la base de datos relacional      | **TA034**   | Crear el diagrama físico de base de datos con claves primarias y foráneas según el modelo de clases.              | 2 horas                | Gabriel Fernando Gordon Salas            | Done       |
|                 |                                             | **TA035**   | Documentar las relaciones clave entre Store, Sensor, Waste y SpotCompany.                                         | 1.5 horas              | Gabriel Fernando Gordon Salas            | Done       |

| **US-049**      | Documentación técnica de relaciones        | **TA036**   | Relacionar cada clase con su tabla correspondiente en la base de datos.                                           | 1 hora                 | Gabriel Fernando Gordon Salas            | Done       |
|                 |                                             | **TA037**   | Documentar las relaciones de herencia, agregación y asociación entre entidades clave.                             | 1.5 horas              | Gabriel Fernando Gordon Salas            | Done       |
...
| Location                            | Discord (Reunión virtual)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Prepared by                    | Valentino Sandoval Paiva                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Attendees (to planning meeting) | Valentino Sandoval Paiva, Renzo Uribe, Fabian Oliva, Marcia Melgarejo, Gabriel GordonPaiva                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Sprint n – 3 Review Summary                    | Se avanzó significativamente en el desarrollo del BackEnd con Java. Se implementaron múltiples endpoints REST y se logró una primera integración con el FrontEnd. Esto permitió visualizar datos reales y sentar las bases del sistema.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Sprint n – 3 Retrospective Summary                   | Se notó una mejora en la comunicación y colaboración entre los miembros, lo cual facilitó el avance en las tareas críticas. Sin embargo, se identificaron oportunidades de optimización en algunos flujos de trabajo para reducir tiempos y mejorar la organización en el manejo de tareas. Se identificó la necesidad de optimizar algunos procesos de desarrollo y coordinación para aumentar la productividad del equipo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Sprint Goal & User Stories       |
 Sprint 3 Goal                    | Nuestro enfoque es fortalecer la base del sistema CleanView mediante el desarrollo y despliegue de endpoints clave en el BackEnd, que permitan gestionar eficientemente puntos de acopio, residuos, sensores y acciones sostenibles. Buscamos ofrecer a los usuarios una experiencia más completa al visualizar información relevante de forma precisa e interactiva, y a los administradores, herramientas para registrar, editar y eliminar datos con facilidad. Además, brindaremos al equipo de desarrollo una interfaz de programación robusta y bien estructurada que facilite la integración de nuevas funcionalidades desde el FrontEnd. Esto se confirmará cuando los usuarios puedan consultar puntos de acopio en un mapa interactivo, aplicar filtros y ver detalles específicos, y los administradores logren gestionar los recursos desde endpoints REST de forma efectiva. |
| Sprint 2 Velocity                | El velocity establecido para el Sprint 3 es de 22 Story Points, lo que es la capacidad que el equipo ha acordado aceptar para este Sprint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Sum of story points             | La suma total de los Story Points incluidos en este Sprint 3 es de 22 Story Points, correspondiente a las tareas estimadas en 66.5 horas de trabajo acumulado.---                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
|----------|------------------------------------------|---------|------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------|--------|
| TS001    | Implementar endpoint para listar puntos de acopio             | TA001  | Crear endpoint para listar puntos de acopio     | Crear un endpoint REST que devuelva todos los puntos de acopio registrados, con nombre, horario, teléfono, materiales y coordenadas.                             | 3                | Valentino Sandoval | Done   |
| TS002    | Implementar endpoint para registrar un nuevo punto de acopio  | TA002   | Crear endpoint para registrar punto de acopio   | Crear un endpoint REST para registrar un nuevo punto con nombre, horario, teléfono, materiales reciclables y ubicación.                                           | 4.5              | Valentino Sandoval | Done   |
| TS003    | Implementar endpoint para detalle de punto de acopio          | TA003   | Crear endpoint para detalle de punto de acopio  | Crear un endpoint que permita consultar los detalles de un punto específico por ID.                                                                               | 3                | Valentino Sandoval | Done   |
| TS004    | Implementar endpoint para eliminar punto de acopio            | TA004   | Crear endpoint para eliminar punto de acopio    | Crear un endpoint REST que permita eliminar un punto existente por su ID.                                                                                          | 2.5              | Valentino Sandoval | Done   |
| TS005    | Implementar endpoint para actualizar datos de punto de acopio | TA005   | Crear endpoint para actualizar punto de acopio  | Crear un endpoint REST que permita modificar los datos de un punto registrado.                                                                                     | 4                | Valentino Sandoval | Done   |
| TS006    | Implementar API para mostrar pines en el mapa interactivo     | TA006   | Crear API para mostrar pines en mapa            | Crear un endpoint que devuelva puntos de acopio con coordenadas geográficas para renderizar pines en mapa con Leaflet.                                            | 3.5              | Valentino Sandoval | Done   |
| TS007    | Implementar endpoint para filtrar puntos por tipo de material | TA007   | Crear endpoint para filtrar puntos por material | Crear un endpoint para aplicar filtros por tipo de material reciclable y mostrar resultados en lista y mapa.                                                       | 4                | Valentino Sandoval | Done   |
| TS008    | Implementar endpoint para búsqueda por nombre                 | TA008   | Crear endpoint para búsqueda de puntos por nombre| Crear un endpoint para buscar puntos de acopio por nombre o parte del nombre.                                                                                      | 3.5              | Valentino Sandoval | Done   |
| TS009    | Añadir Zonas/almacenes mediante RESTful API               | TA009   | Crear endpoint para añadir almacén              | Crear un endpoint POST para registrar un almacén con nombre único, horario, ubicación, etc.                                                                                         | 4                | Gabriel Gordon   | Done   |
| TS010    | Añadir Sensores mediante RESTful API                      | TA0010   | Crear endpoint para añadir sensor               | Crear un endpoint POST para registrar sensores con tipo, estado, ubicación, etc.                                                                                                    | 4                | Gabriel Gordon   | Done   |
| TS011    | Añadir Residuos mediante RESTful API                      | TA0011   | Crear endpoint para añadir residuo              | Crear un endpoint POST para registrar residuos con tipo, unidad, cantidad, ubicación y fecha.                                                                                       | 4.5              | Gabriel Gordon   | Done   |
| TS0012   | Actualizar Zonas/almacenes mediante RESTful API           | TA0012   | Crear endpoint para actualizar almacén          | Crear un endpoint PUT para modificar datos de un almacén existente por ID.                                                                                                          | 3.5              | Gabriel Gordon   | Done   |
| TS0013   | Actualizar Sensores mediante RESTful API                  | TA0013   | Crear endpoint para actualizar sensor           | Crear un endpoint PUT para actualizar sensores con datos válidos por ID.                                                                                                            | 3.5              | Gabriel Gordon   | Done   |
| TS0014   | Eliminar Sensores mediante RESTful API                    | TA0014   | Crear endpoint para eliminar sensor             | Crear un endpoint DELETE para eliminar sensores existentes por ID, incluyendo manejo de errores por ID no existente.                                                               | 3                | Gabriel Gordon   | Done   |
| TS015    | Añadir Acción Sostenible mediante RESTful API                         | TA015-1   | Enpoint para añadir acción sostenible         | Crear un endpoint POST para registrar acciones sostenibles con título, descripción, tipo y favorito.                                                                                      | 4.5              | Marcia Melgarejo   | Done   |
| TS016    | Obtener Todas las Acciones Sostenibles mediante RESTful API           |  TA016-1   |  Enpoint para obtener lista de acciones        | Crear un endpoint GET que devuelva todas las acciones sostenibles registradas.                                                                                                            | 3                | Marcia Melgarejo   | Done   |
| TS017    | Obtener Acciones Sostenibles filtradas por Tipo mediante RESTful API  |  TA017-1   |  Enpoint para filtrar acciones por tipo        | Crear un endpoint GET para obtener acciones filtradas por tipo (e.g., "STORAGE").                                                                                                          | 3.5              | Marcia Melgarejo   | Done   |
| TS018    | Obtener Tipos de Acciones Sostenibles mediante RESTful API            |  TA018-1   |  Enpoint para obtener tipos de acciones        | Crear un endpoint GET que devuelva todos los tipos válidos de acciones sostenibles (e.g., STORAGE, OPERATIONAL).                                                                          | 2.5              | Marcia Melgarejo   | Done   |
| TS019    | Eliminar Acción Sostenible mediante RESTful API                        |  TA019-1  |  Enpoint para eliminar acción sostenible       | Crear un endpoint DELETE que elimine una acción sostenible existente a partir de su ID.                                                                                                    | 3                | Marcia Melgarejo   | Done   |
...
Para el sprint 3 se documentaron *23* endpoints repartidos en 5 controladores. 
...
| Fin del video | 06:27 |
|Link del video: | URL: https://shorturl.at/L37fN |
...
| Duración de todas las entrevistas: 0:00 - 23:27 | URL: https://shorturl.at/L37fN |
...
| Duración de todas las entrevistas: 23:29 - 1:05:20 | URL: https://shorturl.at/L37fN |
...
![alt text](./img/TB2/About-The-Product.png)

https://acortar.link/4h0xTi
...
### 5.2.4.2. Sprint Backlog 4.
 ...
 Durante el cuarto sprint backlog, el equipo completó el front end y back end de la web application, Ademas de implementar autenticación para el register y el login. La herramienta utilizada para
...
| Story ID | Story Title                                      | Task ID | Task Title                                     | Description                                                                                                                                               | Estimation (Hrs) | Assigned To         | Status |
|----------|--------------------------------------------------|---------|------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------------|--------|
| US-033   | Registro de nuevos usuarios                      | TA040   | Programar formulario de registro en frontend     | Crear el formulario de registro en Angular con campos para nombre, email, contraseña y rol.                                                              | 2.5              | Marcia Melgarejo     | Done   |
| US-033   | Registro de nuevos usuarios                      | TA041   | Validar campos del formulario de registro      | Implementar validaciones (campos requeridos, formato de correo, contraseña mínima) y mostrar mensajes de error.                                          | 2                | Marcia Melgarejo     | Done   |
| US-034   | Inicio de sesión para usuarios registrados       | TA042   | Programar formulario de login en frontend        | Crear el formulario de login en Angular con campos de correo y contraseña, y manejo de errores visuales.                                                 | 2                | Marcia Melgarejo     | Done   |
| US-034   | Inicio de sesión para usuarios registrados       | TA043   | Redirección y control de errores en login      | Implementar redirección a `/home` al iniciar sesión correctamente y mostrar mensajes de error si falla.                                                  | 1.5              | Marcia Melgarejo     | Done   |
| TS-028   | Endpoint para registro de usuarios (`/sign-up`)  | TA044   | Implementar lógica de registro en backend      | Programar el endpoint POST `/sign-up` que cree un nuevo usuario con username, email, password y rol.                                                     | 2              | Valentino Sandoval   | Done   |
| TS-028   | Endpoint para registro de usuarios (`/sign-up`)  | TA045   | Validar datos de entrada en el backend         | Agregar validaciones para prevenir registros incompletos o duplicados. Responder con errores claros (400, 409).                                          | 2.5              | Valentino Sandoval   | Done   |
| TS-029   | Endpoint para inicio de sesión (`/sign-in`)      | TA046   | Implementar lógica de login en backend         | Crear el endpoint POST `/sign-in` que valide email y contraseña, y devuelva los datos del usuario con un token JWT.                                      | 3                | Valentino Sandoval   | Done   |
| TS-029   | Endpoint para inicio de sesión (`/sign-in`)      | TA047   | Gestionar errores de autenticación             | Manejar casos de usuario no encontrado o contraseña incorrecta, devolviendo códigos 401 o 404 con mensajes adecuados.                                    | 2                | Valentino Sandoval   | Done   |
| TS-031   | Componente frontend para login/register          | TA050   | Conectar formularios al servicio AuthService   | Conectar el formulario de login y registro con `AuthService` y probar flujo completo de autenticación.                                                  | 2.5              | Marcia Melgarejo     | Done   |
| TS-031   | Componente frontend para login/register          | TA051   | Manejar errores y redirecciones desde el AuthService | Implementar mensajes de error en base a respuestas del backend, y redirección automática tras registro/login.                                      | 2                | Marcia Melgarejo     | Done   |
| TS-032   | Conexión frontend-backend para visualización de Tips       | TA052   | Crear servicio Angular para consumir endpoint de Tips  | Crear un servicio en Angular que realice una petición HTTP GET al endpoint del backend para obtener la lista de Tips sostenibles. | 2              | Marcia Melgarejo   | Done   |
| TS-032   | Conexión frontend-backend para visualización de Tips       | TA055   | Testear flujo completo y validar conexión              | Probar la conexión entre el backend y frontend, verificar que los datos de Tips se reciben correctamente y se renderizan.          | 2                | Marcia Melgarejo   | Done   |
| TS-033   | Conexión del Frontend con el Backend para monitoreo de sensores y zonas | TA033-1 | Crear servicio de consumo de sensores desde el Backend | Implementar un servicio en el frontend para consumir el endpoint de sensores  y zonas vía REST.   | 2.5              | Gabriel Gordon     | Done   |
| TS-033   | Conexión del Frontend con el Backend para monitoreo de sensores | TA033-5 | Prueba manual e integración                          | Verificar  la carga de sensores y su actualización, y probar errores simulando fallas del backend.   | 2                | Gabriel Gordon     | Done   |



![alt text](./img/TF/trello.png)
