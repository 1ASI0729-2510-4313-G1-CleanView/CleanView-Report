...
|-------------------------------------------------------------------------------------|---------------------|--------------|
| 3.c1 Comunica de manera oral con efectividad a diferentes rangos de audiencia       | **Gabriel Gordon TB1:** Realicé una parte del diseño de la landing page, los user person, el journey map, impacting map, user stories, product backlog, diseño del figma tanto wireframes y mock-ups de la landing page y la app, también implementé el diagrama de clases, su descripción y el diagrama de base de daños.   <br>**Valentino Sandoval Paiva**  TB1: Para esta entrega, realicé una matriz de tareas de usuario para entender mejor las necesidades y prioridades de nuestros usuarios. También desarrollé un mapa de empatía para identificar sus emociones y comportamientos clave. Establecí directrices de estilo generales y específicas para la web para garantizar una presentación coherente y efectiva. Configuré el entorno de desarrollo, gestioné el código fuente y definí normas para su estilo y convenciones. Finalmente, preparé la configuración para el despliegue del software, asegurando una implementación fluida y exitosa.   <br>**Fabián Oliva TB1:** Me encargue en realizar una parte del diseño de la landing page, la descripción del startup, Competidores, Análisis de entrevistas del segundo segmento objetivo, Análisis Competitivo, Estrategias y tácticas frente a competidores, Entrevistas, registro de entrevistas, Ubiquitous Language y la 2da versión del diseño de entrevistas <br>**Marcia Melgarejo Gomez**  TB1: Me encargué de explicar de forma clara las actividades de Needfinding, como los User Personas, Task Matrix, Journey Mapping, Empathy Mapping y los escenarios As-Is y To-Be, enfocándome en cómo estas actividades nos ayudaron a entender mejor a nuestros segmentos de usuarios: personas naturales y empresas. También expuse los avances en la arquitectura de información, wireframes, user flows y prototipos de CleanView, asegurándome de que todo esté alineado a las necesidades reales de cada segmento.    <br> **Renzo Uribe Livia** TB1: Me encargue de dar la descripcion al startup, explicar los antecedentes y problematica segun la metodologia de 5W+2H, encontrar a nuestros segmentos objetivos, realize las entrevistas para el primer segmento junto con sus respectivos analisis. Realize el product backlog y los diagramas C4, ademas de ciertas correcciones al landing page.         |  TB1: Cómo conclusión para esta presentación, cada integrante cumplió con sus actividades y se mantuvo una comunicación correcta sobre el proyecto, dando como resultado en este avance una base sólida para seguir con el proyecto            |
| 3.c2 Comunica por escrito con efectividad rangos de audiencia                       |   **Gabriel Gordon TB1:** Realicé una parte del diseño de la landing page, los user person, el journey map, impacting map, user stories, product backlog, diseño del figma tanto wireframes y mock-ups de la landing page y la app, también implementé el diagrama de clases, su descripción y el diagrama de base de daños. <br> **Valentino Sandoval PaivaTB1:** "Al abordar esta entrega, analicé las tareas y necesidades de los usuarios para optimizar la experiencia del software. Desarrollé directrices de estilo para asegurar una presentación coherente, configuré el entorno de desarrollo y gestioné el código fuente. Además, preparé la configuración necesaria para un despliegue exitoso del software.  <br> **Fabián Oliva TB1:** Me encargue en realizar una parte del diseño de la landing page, la descripción del startup, Competidores, Análisis de entrevistas del segundo segmento objetivo, Análisis Competitivo, Estrategias y tácticas frente a competidores, Entrevistas, registro de entrevistas, Ubiquitous Language y la 2da versión del diseño de entrevistas <br>**Marcia Melgarejo Gomez**  TB1: Me encargué de explicar de forma clara las actividades de Needfinding, como los User Personas, Task Matrix, Journey Mapping, Empathy Mapping y los escenarios As-Is y To-Be, enfocándome en cómo estas actividades nos ayudaron a entender mejor a nuestros segmentos de usuarios: personas naturales y empresas. También expuse los avances en la arquitectura de información, wireframes, user flows y prototipos de CleanView, asegurándome de que todo esté alineado a las necesidades reales de cada segmento. <br> **Renzo Uribe Livia** TB1: Me encargue de dar la descripcion al startup, explicar los antecedentes y problematica segun la metodologia de 5W+2H, encontrar a nuestros segmentos objetivos, realize las entrevistas para el primer segmento junto con sus respectivos analisis. Realize el product backlog y los diagramas C4, ademas de ciertas correcciones al landing page. |     TB1: El equipo demostró una buena capacidad de comunicación escrita de forma clara y efectiva. De manera que, todos podamos mejorar nuestro desempeño en grupo al hacer las actividades.      |
...
| EP-03           | Análisis y Reportes de Gestión de Residuos  | **Como** empresario **Quiero** acceder a reportes detallados, comparar datos, evaluar avances y verificar acciones **Para** medir el impacto de las estrategias implementadas y optimizar la gestión de residuos a lo largo del tiempo. | - El usuario debe poder filtrar datos por zona, tipo de residuo, fecha <br> - El usuario debe poder comparar periodos de tiempo distintos <br> - Debe haber una opción para descargar los reportes en formato PDF y Excel  | - |
| EP-04           | Integraciones y Automatización de Procesos  | **Como** empresario **Quiero** integrar sistemas externos, automatizar el recojo y contratar o ofrecer servicios de recolección **Para** reducir carga operativa manual y mejorar la eficiencia del sistema de gestión de residuos. | - El sistema debe enviar notificaciones automáticas a proveedores de recolección según zona y tipo de residuo. <br> - El sistema debe permitir la integración con plataformas externas vía API | - |
| EP-05           |  Educación y Concientización de Residuos  | **Como** usuario **Quiero** recibir consejos, interactuar con un chat de soporte y obtener recomendaciones inteligentes **Para** mejorar mis hábitos de manejo de residuos y contribuir de forma informada a la sostenibilidad. | - El usuario debe poder acceder a un chat interactivo de soporte con información educativa. <br> - El usuario debe poder marcar consejos como "útiles" o "no útiles" para mejorar la personalización futura. <br> - Las interacciones educativas deben estar disponibles desde la app o web sin necesidad de soporte humano constante | - |
| EP-06           | Facilitación del Reciclaje para Ciudadanos  | **Como** ciudadano **Quiero** conocer puntos de reciclaje cercanos, participar en actividades gamificadas y obtener insignias **Para** sentirme motivado a reciclar y hacer de la sostenibilidad una experiencia atractiva y participativa. | - El usuario debe poder participar en desafíos o actividades gamificadas relacionadas con reciclaje <br> - Las insignias deben ser visibles en el perfil del usuario <br> - El sistema debe otorgar insignias o recompensas virtuales al completar acciones sostenibles | - |
...
| US-007           | Chat de soporte ambiental | **Como** visitante <br/> **Quiero** consultar dudas con un asistente virtual <br/> **Para** obtener respuestas sin depender del soporte humano | *Escenario 1:* <br/> **" Comunicación con el asistente virtual en la landing page "** <br/> **Dado que** el visitante visita nuestra pagina web <br/> **Cuando** el visitante selecciona el chat del asistente virtual <br/> **Entonces** el asistente virtual lo saluda con el mensaje e “Hola, ¿Qué te gustaría saber sobre nuestra app?”. <br/><br/> *Escenario 2:* <br/> **" Preguntas frecuentes sobre residuos "** <br/> **Dado que** el visitante visita nuestra pagina web <br/> **Cuando** el visitante selecciona el chat del asistente virtual <br/> **Entonces** el asistente virtual muestra las preguntas frecuentes | EP-05 |
| US-008           | Ofrecer un servicio de recolección | **Como** empresario <br/> **Quiero** ofrecer el servicio de recolección de mi empresa <br/> **Para** poder reclicar más residuos y generar ingresos | *Escenario 1:* <br/> **"Publicación de servicios de resiclaje"** <br/> **Dado que** el empresario usa la aplicación CleanView <br/> **Cuando** accede a la página de "Puntos de copio" <br/> **Entonces** el sistema permite ofrecer el servicio de la empresa a travéz de un registro <br><br> *Escenario 2:* <br/> **"Visibilidad del servicio publicado"** <br/> **Dado que** el empresario ha registrado exitosamente su servicio de recolección en la plataforma <br/> **Cuando** otros ciudadanos o empresas navegan por la sección de “Puntos de acopio” <br/> **Entonces** el sistema muestra la información del servicio ofrecido | EP-04 |
| US-009           | Monitoreo de residuos en tiempo real | **Como** empresario <br/> **Quiero** visualizar la cantidad y tipo de residuos generados en tiempo real <br/> **Para** tomar decisiones en base a los resultados. | *Escenario 1:* <br/> **"El empresario visualiza el panel de Control"** <br/> **Dado que** el empresario usa la plataforma CleanView. <br/> **Cuando** el empresario accede al panel de monitoreo <br/> **Entonces** el sistema muestra la información del control de residuos en sus almacenes <br/><br/> *Escenario 2:* <br/> **"Visualización de alertas por residuos"** <br/> **Dado que** el empresario usa la plataforma CleanVier. <br/> **Cuando** accede al panel de monitoreo. <br/> **Entonces** el sistema detecta un incremento inusual en la generación de residuos. <br> **Y** el sistema genera una alerta automática sobre el problema. <br/><br/> *Escenario 3:* <br/> **"Identificación de los residuos"** <br/> **Dado que** el empresario registrado en la plataforma <br/> **Cuando** el empreserio accede al panel de monitoreo <br/> **Entonces** el sistema detecta un incremento inusual en la generación de residuos. <br> **Y** el sistema me muestra los detalles del residuo  | EP-02 |
| US-010           | Reporte detallado sobre residuos | **Como** empresario <br/> **Quiero** ver reportes detallados de producción y desperdicio <br/>  **Para** tomar decisiones que reduzcan los desperdicios. | *Escenario 1:* <br/> **"Visualización de los detalles de residuo por alertas"** <br/> **Dado que** el empresario se encuentra en el panel de control monitoreando la aparición de residuos. <br/> **Cuando** el empresario selecciona la opción ver detalles de alerta. <br/> **Entonces** el sistema muestre los detalles del residuo que se ha identificado. <br/><br/> *Escenario 2:* <br/> **"Visualización diaria de desperdicio"** <br/> **Dado que** el empresario usa la plataforma CleanView. <br/> **Cuando** el empresario selecciona la ventana de "Panel de Control"<br/> **Entonces** el empresario escoge el monitoreo diario de los residuos <br> **Y** el sistema muestra los detalles de residuos encontrados por medio de un gráfico. <br/><br/> *Escenario 3:* <br/> **"Visualización detallada de los residuos en un gráfico"** <br/> **Dado que** el empresario se encuentra en panel de control. <br/> **Cuando** el empresario selecciona una barra de la grafica <br/> **Entonces** el sistema muestra los detalles de residuos encontrados en ese momento. | EP-03 |
...
|---------|---------------|--------------------------------------------------|--------------------------------------------------------------------------------------------------|--------------------------|
| 1       | US-009        |  Monitoreo de residuos en tiempo real  | **Como** empresario <br/> **Quiero** visualizar la cantidad y tipo de residuos generados en tiempo real <br/> **Para** tomar decisiones en base a los resultados.   | 3  |
| 2       | US-022           | Consejos para manejo de residuos | **Como** ciudadano <br/> **Quiero** recibir consejos del cuidado ambiental y reciclaje <br/> **Para** reducir residuos en casa.  | 2 |
| 3       | US-020           | Añadir nueva zona de monitoreo | **Como** empresario <br/> **Quiero** añadir una nueva zona de monitoreo con sensores <br/> **Para** gestionar los residuos en distintas áreas. | 3 |
| 4       | US-012           | Comparación entre periodos | **Como** empresario <br/> **Quiero** comparar residuos entre meses <br/> **Para** identificar patrones de generación de residuos. | 5 |
| 5       | US-015           | Integración con sensores IoT | **Como** empresario <br/> **Quiero** usar sensores inteligentes <br/> **Para** monitoreo automático los residuos. | 5 |
...
**Branding e Icono:**
El logo de CleanWind representa su compromiso con el medio ambiente mediante un diseño simple y simbólico. Además, se busca que sea un logo minimalista y atractivo para el usuario. 
...
| ---------------------------------------------- | ----------------- | ------------------------------------------ | ----------------------------------- | ----------------------------------- | --------------------------------- | ------------------------------------ | ------------------------------------------ | ---------------------------- | ------------------------------------- | ------------------------------------------------------------ | -------------------------------- |
| Renzo Sebastian Uribe Livia                    | JKOlimpo         | C                                          | L                                                                      |                                   | C                                    | L                                          | C                            |                                       | L                                                             |                                  | L
| Fabian Alejandro Oliva Lopez                   | FabulousFavStar    | L                                          | C                                   | C                                   |                                   | L                                    | C                                          | L                            |                                       |                                                              |                                  |
| Valentino Sandoval Paiva                       | SoyValzzz | L                                          | C                                   | L                                   | C                                 | L                                    | C                                          | L                            | C                                      |  C                                                            |   C                               |
| Marcia Victoria Melgarejo Gomez                | Mevi1217     | L                                          | L                                   | L                                   | C                                 | C                                    | L                                          |                              | C                                      |                                                              |                                  |
| Gabriel Fernando Gordon Salas                  | Silent343          | C                                          | L                                   | L                                   | C                                 | L                                    | C                                          | L                            |                                       |     C                                                         |  C                                | 
...
Angular. (n.d.). Introduction to Angular. Angular Official Documentation. Retrieved from https://angular.io/guide/what-is-angular

Angular Material. (n.d.). Getting started with Angular Material. Angular Material Docs. Retrieved from https://material.angular.io/guide/getting-started

Angular. (n.d.). Angular Forms Guide. Angular Official Documentation. Retrieved from https://angular.io/guide/forms-overview
