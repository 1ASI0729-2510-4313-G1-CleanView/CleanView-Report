...
|-----------------|--------|-------------|--------------------------|----------------------------|
| US-001 | Experiencia de Reciclaje Guiada | **Como** ciudadano comprometido con el medio ambiente <br/> **Quiero** que la aplicación me indique qué, cómo y dónde reciclar <br/> **Para** contribuir eficazmente a la sostenibilidad desde mi hogar. | *Escenario:* <br/> **"Guía de reciclaje personalizada"** <br/> **Dado que** soy un usuario registrado <br/> **Cuando** accedo a la sección de reciclaje <br/> **Entonces** visualizo una lista con instrucciones detalladas sobre cómo clasificar y reciclar mis residuos según mi ubicación. | - |
| US-002 | Incentivos por Reciclar | **Como** usuario <br/> **Deseo** acumular puntos por mis acciones de reciclaje y canjearlos por recompensas <br/> **Para** sentirme motivado a mantener hábitos sostenibles. | *Escenario:* <br/> **"Sistema de puntos por reciclaje"** <br/> **Dado que** he registrado una acción de reciclaje <br/> **Cuando** el sistema valida la acción <br/> **Entonces** se suman puntos a mi perfil que podré canjear posteriormente. | - |
| US-003 | Acceso a Puntos de Reciclaje Cercanos | **Como** ciudadano <br/> **Quiero** visualizar en un mapa los centros de reciclaje más cercanos <br/> **Para** facilitar la entrega de mis residuos reciclables. | *Escenario:* <br/> **"Ubicación de puntos de reciclaje"** <br/> **Dado que** otorgo permiso de ubicación <br/> **Cuando** abro el mapa de reciclaje <br/> **Entonces** el sistema muestra los puntos más cercanos con información de contacto y horarios. | - |
| US-004 | Recomendaciones Personalizadas | **Como** usuario <br/> **Me gustaría** recibir consejos personalizados sobre reciclaje <br/> **Para** mejorar continuamente mis prácticas y reducir mi impacto ambiental. | *Escenario:* <br/> **"Consejos personalizados"** <br/> **Dado que** he registrado mis hábitos de reciclaje <br/> **Cuando** reviso la sección de recomendaciones <br/> **Entonces** obtengo sugerencias adaptadas a mis actividades previas. | - |
| US-005 | Monitoreo Automatizado de Residuos | **Como** empresa <br/> **Quiero** automatizar el control y registro de mis residuos <br/> **Para** optimizar mis operaciones y cumplir con las normativas ambientales. | *Escenario:* <br/> **"Registro automático de residuos"** <br/> **Dado que** tengo sensores instalados en mi planta <br/> **Cuando** se genera un nuevo residuo <br/> **Entonces** el sistema registra automáticamente su tipo y volumen. | - |
| US-006 | Coordinación con Centros de Reciclaje | **Como** organización <br/> **Deseo** conectar fácilmente con recicladores <br/> **Para** gestionar eficientemente la recolección y disposición de mis residuos. | *Escenario:* <br/> **"Solicitud de recolección"** <br/> **Dado que** he acumulado una cantidad significativa de residuos <br/> **Cuando** accedo a la sección de coordinación <br/> **Entonces** puedo agendar una recolección con un centro cercano. | - |
| US-007 | Generación de Reportes Ambientales | **Como** responsable de cumplimiento ambiental <br/> **Necesito** generar informes detallados sobre la gestión de residuos <br/> **Para** asegurar la transparencia y cumplimiento regulatorio. | *Escenario:* <br/> **"Generación de informe PDF"** <br/> **Dado que** he registrado actividades de reciclaje <br/> **Cuando** selecciono un período específico <br/> **Entonces** el sistema genera un reporte descargable en PDF con todos los datos pertinentes. | - |
| US-008 | Alertas de Volumen de Residuos | **Como** empresa <br/> **Quiero** recibir alertas cuando los volúmenes de residuos superen ciertos umbrales <br/> **Para** tomar acciones preventivas y evitar sanciones. | *Escenario:* <br/> **"Notificación por exceso de residuos"** <br/> **Dado que** los sensores superan el umbral configurado <br/> **Cuando** esto ocurre <br/> **Entonces** el sistema me envía una notificación automática y sugiere una acción. | - |
| US-009 | Navegación Intuitiva | **Como** usuario nuevo <br/> **Deseo** una interfaz clara y fácil de usar <br/> **Para** comprender rápidamente cómo utilizar la plataforma y aprovechar sus funcionalidades. | *Escenario:* <br/> **"Exploración sencilla de la plataforma"** <br/> **Dado que** accedo por primera vez <br/> **Cuando** navego entre secciones <br/> **Entonces** comprendo intuitivamente cómo interactuar con cada módulo. | - |
| US-010 | Asistencia Virtual Proactiva | **Como** usuario <br/> **Me gustaría** contar con un asistente virtual que responda mis dudas en tiempo real <br/> **Para** resolver inconvenientes sin demoras. | *Escenario:* <br/> **"Chatbot con respuestas en vivo"** <br/> **Dado que** tengo una duda operativa <br/> **Cuando** abro el chat de ayuda <br/> **Entonces** recibo una respuesta automática útil o me conecta con un agente. | - |
| US-011 | Registro y Acceso Simplificados | **Como** nuevo usuario <br/> **Quiero** un proceso de registro y acceso sencillo <br/> **Para** comenzar a utilizar la plataforma sin complicaciones. | *Escenario:* <br/> **"Inicio de sesión con un clic"** <br/> **Dado que** tengo una cuenta de Google o Facebook <br/> **Cuando** presiono el botón de inicio de sesión social <br/> **Entonces** accedo directamente sin formularios extensos. | - |
| US-012 | Información Transparente sobre Privacidad | **Como** usuario consciente de la privacidad <br/> **Deseo** acceder fácilmente a las políticas de uso y privacidad <br/> **Para** entender cómo se manejan mis datos personales. | *Escenario:* <br/> **"Visualización de políticas"** <br/> **Dado que** me interesa cómo se usan mis datos <br/> **Cuando** navego a la sección de políticas <br/> **Entonces** visualizo un resumen claro y descargable de las condiciones de privacidad. | - |
...
|---------|---------------|--------------------------------------------------|--------------------------------------------------------------------------------------------------|--------------------------|
| 1       | US-001        | Monitoreo de residuos en tiempo real             | **Como** empresario <br/> **Quiero** visualizar la cantidad y tipo de residuos generados en tiempo real <br/> **Para** tomar decisiones rápidas.         | 5                        |
| 2       | US-002        | Reporte detallado sobre residuos                 | **Como** empresario <br/> **Quiero** ver reportes detallados de producción y desperdicio <br/>  **Para** tomar decisiones que reduzcan los desperdicios y mejoren la eficiencia.       | 3   |
| 3       | US-003        | Puntos de reciclaje cercanos                     | **Como** Ciudadano <br/> **Quiero** ver puntos de reciclaje cerca de mi casa <br/> **Para** poder reciclar fácilmente y contribuir al cuidado del medio ambiente                      | 3   |
| 4       | US-004        | Consejos para manejo de residuos                 | **Como** Ciudadano <br/> **Quiero** recibir consejos del cuidado ambiental y reciclaje <br/> **Para** reducir residuos en casa.      | 2        |
| 5       | US-005        | Gamificación ecológica                           |  **Como** Ciudadano <br/> **Quiero** recibir puntos por buenas prácticas <br/> **Para** motivarme más a reciclar  | 2         |
| 6       | US-006        | Alertas por umbrales críticos                    | **Como** Empresario <br/> **Quiero** alertas cuando los residuos superen un umbral <br/> **Para** poder tomar decisiones rápidas que garanticen el cumplimento ambiental  | 3 |
| 10      | US-007        | Comparación entre periodos                       |  **Como** Empresario <br/> **Quiero** comparar residuos entre meses <br/> **Para** identificar patrones de generación y evaluar la efectividad de estrategias de reducción       | 3 |
| 11      | US-008        | Ranking interno de sostenibilidad                | **Como** Empresario <br/> **Quiero** ver áreas que generan menos recursos <br/> **Para** replicar estrategias eficientes en otras áreas     | 2                        |
| 12      | US-009        | Exportación de reportes                          | **Como** Empresario <br/> **Quiero** exportar reportes en PDF o Excel <br/> **Para** analizarlos fuera del sistema y compartirlos con mi equipo    | 8                        |
| 13      | US-010        | Integración con sensores IoT                     | **Como** Empresario <br/> **Quiero** usar sensores inteligentes <br/> **Para** monitoreo automático e residuos | 2        |
| 14      | US-011        | Notificación por tipo de residuo                 |  **Como** Empresario <br/> **Quiero** recibir alertas si un tipo específico de residuo aumenta <br/> **Para** poder tomar decisiones rápidas que mitiguen impactos negativos   | 2         |
| 15      | US-012        | Servicio de recojo automático                    | **Como**empresario <br/> **Quiero** que se solicite un servicio de recojo automáticamente cuando los sensores detectan que el 80% está lleno <br/> **Para** evitar acumulaciones y mantener la limpieza.   | 3      |
| 16      | US-013        |                  |                |            |
| 17      | US-014        | chat de soporte ambiental                        | **Como** Usuario <br/> **Quiero** consultar dudas con un asistente virtual <br/> **Para** obtener respuestas rápidas y precisas sin depender del soporte humano | 3                        |
| 18      | US-015        | Verificación de acciones sostenibles             | **Como** Empresario<br/> **Quiero** validar si las acciones implementadas reducen residuos <br/> **Para** medir su efectividad y ajustar estrategias en función de resultados    | 5                        |
| 19      | US-016        |  Integración con APIs externas                   | **Como** Desarrollador<br/> **Quiero** conectar CleanWind a otras plataformas <br/> **Para** integrar datos y funcionalidades con sistemas externos         | 2                        |
| 23      | US-017        |   Recomendaciones inteligentes                   | **Como** Usuario<br/> **Quiero** recibir recomendaciones personalizadas según mis datos <br/> **Para** tomar decisiones más informadas que me ayuden a reducir residuos   | 3          |
| 20      | US-018        |  Sistema de insignias por logros sostenibles     |**Como** Usuario<br/> **Quiero**  recibir insignias por hitos alcanzados <br/> **Para** motivarme, reconocer mis logros y visualizar mi progreso   | 5                        |
