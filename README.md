...
**Épicas**  
 ...
 <tr>
    <th colspan="2">Épica 1: Experiencia del Usuario en la Landing Page	</th>
  </tr>
  <tr>
    <td colspan="2">
      <strong>Como</strong> usuario, <br/>
      <strong>Quiero</strong> tener una experiencia fluida y atractiva en la landing page de la plataforma, para que pueda entender fácilmente los beneficios y funcionalidades clave, y tomar una decisión informada sobre registrarme. <br/>
    </td>
  </tr>

| User Story ID | Título |
|---------------|--------|
| US-001    | Navegación Clara y Eficiente |
| US-002    | Accesos Visibles para Login/Registro |
| US-003    | Comprensión del Valor de la Plataforma |
| US-004    | Información de Recompensas y Reciclaje |
| US-005    | Diseño Responsivo en Móviles |
| US-006    | Botones Accesibles en Dispositivos Táctiles |
| US-007    | Uso de Imágenes y Gráficos Ilustrativos |
| US-008    | Visualización de Recompensas Atractiva |
| US-009    | Transparencia de la Empresa |
| US-010    | Credibilidad de la Plataforma |
...
|-----------------|--------|-------------|--------------------------|----------------------------|
| US-001 | Navegación Clara y Eficiente | **Como** visitante interesado en la gestión de residuos <br/> **Quiero** acceder fácilmente a las secciones clave de la página <br/> **Para** comprender rápidamente los servicios que ofrece CleanView. | *Escenario:* <br/> **"Acceso intuitivo a secciones"** <br/> **Dado que** ingreso a la landing page <br/> **Cuando** hago clic en cualquier enlace del menú superior <br/> **Entonces** soy dirigido correctamente a la sección correspondiente. | EP-00 |
| US-002 | Accesos Visibles para Login/Registro | **Como** usuario potencial <br/> **Quiero** ver claramente los botones de “Iniciar sesión” y “Registrarse” <br/> **Para** acceder o crear una cuenta sin complicaciones. | *Escenario:* <br/> **"Visibilidad de botones de acceso"** <br/> **Dado que** estoy en la parte superior de la landing <br/> **Cuando** observo el header <br/> **Entonces** puedo identificar rápidamente los accesos a login y registro. | EP-00 |
| US-003 | Comprensión del Valor de la Plataforma | **Como** representante de una empresa <br/> **Quiero** entender cómo CleanView me ayuda con la gestión de residuos <br/> **Para** evaluar su implementación en mi organización. | *Escenario:* <br/> **"Mensaje claro de beneficios"** <br/> **Dado que** ingreso a la landing <br/> **Cuando** leo la sección principal de beneficios <br/> **Entonces** entiendo el impacto y utilidad de la plataforma. | EP-00 |
| US-004 | Información de Recompensas y Reciclaje | **Como** ciudadano comprometido <br/> **Quiero** conocer cómo reciclar correctamente y obtener recompensas <br/> **Para** motivarme a usar la aplicación de forma constante. | *Escenario:* <br/> **"Sección de recompensas visible"** <br/> **Dado que** reviso la página <br/> **Cuando** navego por la sección de reciclaje y puntos <br/> **Entonces** entiendo cómo funciona el sistema de recompensas. | EP-00 |
| US-005 | Diseño Responsivo en Móviles | **Como** usuario móvil <br/> **Quiero** que la página se adapte correctamente a mi pantalla <br/> **Para** navegar sin dificultades desde cualquier dispositivo. | *Escenario:* <br/> **"Adaptabilidad responsive"** <br/> **Dado que** accedo desde un smartphone o tablet <br/> **Cuando** navego por la landing <br/> **Entonces** todo el contenido se muestra adecuadamente sin desbordes ni cortes. | EP-00 |
| US-006 | Botones Accesibles en Dispositivos Táctiles | **Como** usuario móvil <br/> **Quiero** que los botones sean fácilmente seleccionables <br/> **Para** interactuar sin errores desde mi dispositivo. | *Escenario:* <br/> **"Interacción táctil efectiva"** <br/> **Dado que** uso una pantalla táctil <br/> **Cuando** intento presionar botones o enlaces <br/> **Entonces** la acción se ejecuta correctamente sin equivocaciones. | EP-00 |
| US-007 | Uso de Imágenes y Gráficos Ilustrativos | **Como** usuario visual <br/> **Quiero** ver ilustraciones del funcionamiento de la app <br/> **Para** comprender mejor su uso y beneficios. | *Escenario:* <br/> **"Sección visual informativa"** <br/> **Dado que** veo las secciones explicativas <br/> **Cuando** observo las imágenes o gráficos <br/> **Entonces** comprendo visualmente cómo opera la plataforma. | EP-00 |
| US-008 | Visualización de Recompensas Atractiva | **Como** visitante interesado <br/> **Quiero** ver representaciones visuales de las recompensas <br/> **Para** motivarme a participar en el reciclaje con CleanView. | *Escenario:* <br/> **"Motivación visual a través de recompensas"** <br/> **Dado que** llego a la sección de beneficios <br/> **Cuando** veo íconos, premios o puntos mostrados <br/> **Entonces** me siento incentivado a registrarme y participar. | EP-00 |
| US-009 | Transparencia de la Empresa | **Como** usuario que valora la transparencia <br/> **Quiero** conocer la misión y visión de CleanView <br/> **Para** confiar en sus objetivos y filosofía. | *Escenario:* <br/> **"Acceso a información institucional"** <br/> **Dado que** leo la sección “Sobre Nosotros” <br/> **Cuando** navego por ella <br/> **Entonces** obtengo claridad sobre su propósito y compromiso ambiental. | EP-00 |
| US-010 | Credibilidad de la Plataforma | **Como** potencial cliente empresarial <br/> **Quiero** entender la experiencia de CleanView en el sector <br/> **Para** confiar en su profesionalismo. | *Escenario:* <br/> **"Confianza basada en trayectoria"** <br/> **Dado que** reviso información institucional <br/> **Cuando** se muestran datos sobre su experiencia o alianzas <br/> **Entonces** me siento seguro de trabajar con ellos. | EP-00 |
