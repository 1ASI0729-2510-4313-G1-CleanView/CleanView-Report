...
|-----------------|--------|-------------|--------------------------|----------------------------|
| US-001 | Navegación Clara y Eficiente | **Como** visitante interesado en la gestión de residuos <br/> **Quiero** acceder fácilmente a las secciones clave de la página <br/> **Para** comprender rápidamente los servicios que ofrece CleanView. | *Escenario:* <br/> **"Acceso intuitivo a secciones"** <br/> **Dado que** ingreso a la landing page <br/> **Cuando** hago clic en cualquier enlace del menú superior <br/> **Entonces** soy dirigido correctamente a la sección correspondiente. | EP-01 |
| US-002 | Accesos Visibles para Login/Registro | **Como** usuario potencial <br/> **Quiero** ver claramente los botones de “Iniciar sesión” y “Registrarse” <br/> **Para** acceder o crear una cuenta sin complicaciones. | *Escenario:* <br/> **"Visibilidad de botones de acceso"** <br/> **Dado que** estoy en la parte superior de la landing <br/> **Cuando** observo el header <br/> **Entonces** puedo identificar rápidamente los accesos a login y registro. | EP-01 |
| US-003 | Comprensión del Valor de la Plataforma | **Como** representante de una empresa <br/> **Quiero** entender cómo CleanView me ayuda con la gestión de residuos <br/> **Para** evaluar su implementación en mi organización. | *Escenario:* <br/> **"Mensaje claro de beneficios"** <br/> **Dado que** ingreso a la landing <br/> **Cuando** leo la sección principal de beneficios <br/> **Entonces** entiendo el impacto y utilidad de la plataforma. | EP-01 |
...
| US-006 | Botones Accesibles en Dispositivos Táctiles | **Como** usuario móvil <br/> **Quiero** que los botones sean fácilmente seleccionables <br/> **Para** interactuar sin errores desde mi dispositivo. | *Escenario:* <br/> **"Interacción táctil efectiva"** <br/> **Dado que** uso una pantalla táctil <br/> **Cuando** intento presionar botones o enlaces <br/> **Entonces** la acción se ejecuta correctamente sin equivocaciones. | EP-01 |
| US-007 | Uso de Imágenes y Gráficos Ilustrativos | **Como** usuario visual <br/> **Quiero** ver ilustraciones del funcionamiento de la app <br/> **Para** comprender mejor su uso y beneficios. | *Escenario:* <br/> **"Sección visual informativa"** <br/> **Dado que** veo las secciones explicativas <br/> **Cuando** observo las imágenes o gráficos <br/> **Entonces** comprendo visualmente cómo opera la plataforma. | EP-01 |
